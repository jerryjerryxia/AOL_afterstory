...
## 三周目：“完美夏日”
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "在彻骨的极寒中，一切都有如冰封般凝滞，即使世界上恒久的变化也停息了。"
    extend "\n这也是代价么？"
    extend "\n嗯...或是代价的利息？"
    extend "\n究竟在这冰雕中困了多久了呢？"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "深海的手臂将你缓缓拉回海底，但你已在毒液带来的麻木中释然。"
    ...
    menu:
        ...
        "把手中的无色透明多面体丢在了沙滩上":
            ...
            "你又想起了梦中的那个人——她的音容笑貌是如此真实，仿佛你们在这片土地上同时存在过。"
            "但梦终究是梦，总有幻灭的时刻，没什么可惋惜的。"
            "只是这怅然若失的感觉，究竟是从何而来的呢？"
            "雨越下越大，街道边雨水已经汇聚成汩汩的小溪，去无方向地向前奔涌。"
            "现在要回去上班恐怕还是太早了，你这样想。"
        ...
        "把手中的无色透明多面体装回裤兜里【需要madness大于某个数字】":
            ...
            ahe "哦，原来是有时限的。"
            wangshuang "但要是有人在那之前发现了我们的“尸体”然后拿去烧了，那就非常滑稽了。"

...
## 三周目：“完美夏日”
    ...
    ahe "我大概会重新回去上班。"
    wangshuang "那也太...无聊了..."
    ahe "确实，我也这么觉得。风风火火闹了一通之后，反而要一头扎回那避之不及的‘日常’，所有的努力全都打了水漂，无论怎么看都是一种非常令人恼火的结局。"
    ...
    ahe "你从没讲过。"
    wangshuang "当然，我没有和任何人讲过。所有意识的终点之所以是夏日的海滩，是因为刚见到发病的你时，我第一次看到了太阳的颜色。"
    wangshuang "你身上的金色是一种其他任何地方都看不到的美丽色彩，只从你身上散发出来。相比之下，其他地方的灰色就越发显得压抑了。"
    ...
    ## 轻微嘈杂人声变得略响
    wangshuang "因为这里是蜂巢的源头，所有人的意识都储存在这里。所以现在你就可以放手去摧毁一切了。"
    ahe "摧毁？为什么要我来做？"
    wangshuang "因为这是你的使——"
    ahe "这难道不是你的愿望么？"
    wangshuang "..."
    ...
    extend "\n所以...即使会患上新的病，即使一切都因此而凝滞了...我也..."
    extend "\n我也..."
    ## Extended文本框结束
    ahe "你也要移开目光么？"
    wangshuang "我没有！眼前这一切就是我想要的，我是绝不可能亲手把它毁掉的啊！"
    ahe "哦，所以直到最后一刻也要借刀杀人。"
    ...
    wangshuang "阿鹤...我..."
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "王霜一副欲言又止的样子，她紫水晶色的双眼中流露出因认命而产生的淡淡悲戚。沉默良久后，眼神里又略微有了些光。她站起来，背对着你，右手在裤兜里摸索着什么。"
    ...
    wangshuang "这不是陪葬。这是献祭。已经...拖了太久了。"
    ahe "可是——"
    wangshuang "不必再说，从来到这里的那一天，我就从来没有想过要离开。"
    ahe "即使要在凝滞中永远停留下去？"
    wangshuang "现在我心情非常好，好得不能再好了，所以能麻烦你不要再在这里像蚊子一样嗡嗡作响吗？你让我做的，我全都做到了，Succumus关停了，逝乐园已经得救了，你也自由了。"
    wangshuang "我也什么都不剩了，所以能请你把这最后的定夺权留给我自己吗？"
    ahe "好吧...那我——"
    ...
    menu:
        ...
        "把手中的无色透明多面体丢在了沙滩上":
            ...
            extend "\n仿佛再往北走几部你就能走到她家楼下，爬上三楼、敲敲门就能进入她那常年潮气过重的出租屋。"
            extend "\n你想起在她冷酷般的操纵下你度过的噩梦般的不知多少天，以及在你的意识终归沉寂后才涌现出的完美夏日。"
            ...
            extend "\n现在要回去上班恐怕还是太早了，你这样想。"
            extend "\n整个逝乐园都还在这晦暗的雨幕中缓缓苏醒，所有人都需要更多的时间。"
        ...
        "把手中的无色透明多面体装回裤兜里【需要madness大于某个数字】":
            ...
            ## Extended大文本框结束
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "在无垠黑暗中，一切都融为一体。对于反复经历过灰幕的你来说，这是一副无比熟悉的、关于轮回和宿命的平淡场景。"
            extend "\n随着无止境的下潜，你手指结冰，四肢也失去了知觉，如今只是依凭着肌肉记忆不断重复着机械的划水动作。"
            extend "\n随着体温不断下降，身边的黑暗反倒显得温暖了起来，你在长久的感官剥夺中逐渐与周身失去了边界。一切都在交融。"
            ...
            extend "\n你的目的地从来就不存在。"
            extend "\n也许“王霜”这个概念也从来就不存在。"
            extend "\n她确实说过你到不了她那儿。只是你根本没放在心上，一头就扎进了水里。"
            ...
            wangshuang "那就把我们的意识上传到别人身体里咯。反正Succumus随时可以重启。"
            ahe "啊？还来啊？"
            wangshuang "嘿嘿，开玩笑的。"
            ahe "阿霜。"
            wangshuang "怎么了？"
            ahe "其实Succumus根本从来都没有关掉，对吧？"
            wangshuang "哦，你发现了啊。"
            ...
            "再点就回主菜单咯。"
            ## Happy End?
            ## 当 Normal End 和 Happy End(?) 均已完成后，出现选项C
            "C：草拟“现实”与“深海”"
            ## 事件背景：阿鹤终于意识到了王霜和他处在的这个世界，正是一周目里王霜提到的“认知草拟”，而之前所经历的两个一般结局也无不是草拟的一部分，只有从海底巨大的冰川中把真正的王霜解救出来，才能真正解决这一事件。在经历一般结局之后的阿鹤拥有了当前事件节点的两个选择支的部分知识，并以此为基础开始双线程认知草拟，完整地草拟现实和深海的双线情景，并在两个场景之间交叉推进以找到解放真王霜的方法。
            ## 王霜主观上已经彻底沉溺于她以Succumus为自己创造的弥天之瘾里，无论如何都拒绝离开。这时阿鹤需要在草拟的现实中找到心理视像算法V27.3.9 - 由于Succumus的高精度感官复现，阿鹤能在草拟的现实中去到王霜的医院并内化这一算法。在学习算法之前，阿鹤能够在草拟中进行简单的物质操控和场景切换，但在花了大量时间完整地学习了算法后，阿鹤得到了与王霜相当的权限。
            "但【与王霜相当的权限并无法解放她 - Succumus未解除，蜂巢心智依然存在，其本质就是王霜在长时间接触全知全能之后染上的弥天之瘾的意识集合体。在意识到阿鹤正逐渐取得更高等级的权限时，全知全能的瘾开始侵蚀深海冰川中阿鹤的心智。阿鹤以新取得的权限勉强抵抗，但很快露出疲态。】"
            ## “现实”中的阿鹤则开始寻找出路。由于两边都是草拟，王霜之前提到的拉闸威胁并不管用，阿鹤必须找到能够正面破除深海冰川的解决方案。
            ## 这时阿鹤想到了之前王霜提到的认知过载。他意识到现在的他之所以能够进行长时间高强度的认知草拟，是因为Succumus中包含了逝乐园半岛全部居民的意识，分担了巨量的算力负担，但如果阿鹤选择主动舍弃系统自带的并发运算，并把运算方式改成单线程按序处理，就可以以自己为开端产生一连串的认知过载。虽然其体量不及蜂巢心智总体量的10%，但这10%过载产生的连锁反应大概率会导致Succumus服务器宕机，强制弹出所有的草拟用户的同时结束草拟。
            ## 但风险也非常明确：阿鹤必须以自己为导火索来引发这连锁反应，并在宕机发生之前持续保持过载的状态，简单来说是一种自杀式袭击。
            ## 更改完配置后，阿鹤全身燃烧了起来，他用晶体护住全身，但还是在认知过载导致的超高温中逐渐陷入昏迷。在意识飘走的前一刻，他看见了浮在漆黑海面上向下看的自己，站在明丽沙滩上朝天看的自己，他又想起了王霜最初的断言——他此刻就像太阳一样稳定。他似乎理解了他的使命究竟是什么，但又不慎明确——究竟是解救王霜，还是解放逝乐园被困在Succumus里的人们，亦或是单纯让王霜无法如愿？但在想明白之前就彻底失去了意识。
            ## 视角转到王霜，她醒来后发现身边的冰川已经消融殆尽，同时身边有一个如同太阳般恒常燃烧的阿鹤，立刻开始动用她取之不尽的冰试图将阿鹤身上的火扑灭——不是为了救他，而是为了维持冰川，但王霜的瘾冰在阿鹤献上意识生成的火面前不堪一击，很快融化了全部的冰。Succumus至此宕机，两人真正回到现实。
            ## 回到现实后，由于王霜在最后一刻的持续扑救，阿鹤并未完全脑死亡，但大脑被烧得只剩下了薄薄的皮层，目前处在植物人的状态。王霜辞去了医院的工作，自己开了一家心理咨询工作室，并长年照顾昏迷的阿鹤。最后表示说历史上出现过脑内空洞比阿鹤还要大得多的人，最后仅是腿脚不太方便而已，所以她对阿鹤的康复抱有莫大的信心，还咿咿呀呀了一堆展望未来的东西，顺便骂了一顿阿鹤，全剧终。
            ## 现实扭曲音效
            wangshuang "你在干嘛？"
            ...
            wangshuang "...那真是...无聊的使命啊..."
            ahe "嗯，大概吧。但就像你说的，使命与想法是毫无关联的，当意识到使命的归处时，我早就已经别无选择了。"
            ...
            wangshuang "谁知道呢。看心情吧。现在心情一直很好就是了。"
            ahe "那就好。"
            wangshuang "不如你也来——"
            ahe "容我婉拒。"
            ...
            $ current_scene_desc = None
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "哦，但直接限制权限岂不更容易些？这都是你能做到的事情。"
            extend "\n阿霜说她一票否了？你看，想要她永远留在那海底的，其实只有你吧。"
            extend "\n这可不是诡辩哦，她的行为已经把她的态度表现得明明白白了。她说了什么并不重要。"
            ...
            extend "\n配置不对？"
            extend "\n我在第四个月的时候就已经说过了，配置肯定是对的。得排查服务器本身。"
            extend "\n所以我们回去行不行？这里什么也干不了。"
            ## Extended大文本框结束
            ## 转场：逝乐园
            $ current_scene_name = "逝乐园"
            ...
            extend "\n你也忘了啊。好吧，那在这长到连你都记不住的时间里，为什么大多数时候你都在帮我，我的蜂哥？"
            extend "\n哦，这样。威胁评估还是没有达到阈值。"
            extend "\n把整个地表改造成数据中心都不足以让你稍微产生一点恐惧么..."
            extend "\n嗯，也是，那样你反倒是有了近乎无限的生存空间。"
            extend "\n但这一切的终点，或许就是你的末日，这样也没有关系么？"
            extend "\n好吧，原来是这样..."
            ...
            wangshuang "你做到了？"
            ahe "嗯，稍微花了点时间。"
            wangshuang "（史上首次花颜失色）你这疯子。"
            ahe "彼此彼此。"
            wangshuang "（立刻恢复镇定）可要想明白啊，你会死的哦。"
            ahe "我以为你会帮我拦着蜂巢的。"
            wangshuang "嗯...我看看...不是，我拿头帮你拦！权限不已经全都移到你名下了吗？"
            ...
            wangshuang "这么容易？"
            ahe "嗯，不管你看到什么。"
            wangshuang "是“如果看到你快死了不要来救”这样的戏码吗？这个我擅长，保证按兵不动的。"
            ahe "现在不好说，但总之你能管住自己的手就帮大忙了。"
            ...
            ahe "也是好事，毕竟这样我也不用想太多了。无机集成涌现而出的意识，果然到最后也难以认为是真正的人类啊。"
            wangshuang "废话。"
            ahe "可是你似乎完全乐在其中的样子，在它给你设计的梦里。"
            wangshuang "次序错了——是我让它给我设计的梦。"
            ahe "可你已经不再拥有完全控制权了。"
            wangshuang "那或许是最好的结果。"
            ahe "所以连你也逃脱不了成瘾的命运么..."
            wangshuang "哈哈...还是关心关心你自己吧，阿鹤。"
            ## 转场：两座冰雕4
            $ current_scene_name = "两座冰雕4"
            $ current_scene_desc = "阿鹤看起来正在迅速失温，肤色发青。"
            ahe "虽然我也很想随波逐流下去，但现在我没有这么做的余裕，蜂巢。"
            ahe "被这冰冻住身体，无论是谁都会立刻陷入永无止境的美梦吧。"
            ...
            wangshuang "别这么记仇啊！"
            ahe "嗯，倒也不是记仇，只是印象太深了。"
            ahe "现在想来，也许那时候你就已经草拟到了这一刻？多少有点过分啊，阿霜。"
            wangshuang "哈？你在说什么？"
            ahe "虽然直到最后一刻也不太清楚自己所谓“使命”究竟是什么，但现在我离完成它就只差最后一步了，这点非常清楚。"
            wangshuang "阿鹤，能不能把话说明白！"
            ...
            wangshuang "你——"
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "阿霜的面部肌肉和双唇继续着无序运动，大概是在说些什么，但你已无暇理会。"
            extend "\n熟练掌握心理视像算法后，你能够在散发出高热的同时不把自己烧成灰，但这终究是超越人体工程学的壮举，让你各种意义上汗流浃背，稍有不慎就会引火烧身。"
            extend "\n周身的冰川正以肉眼可见的速度消融，如果从远处看，就能见到一个暖色的球状空洞正在这本应永冻的海底迅速膨胀。"
            extend "\n但蜂巢自然不会善罢甘休。"
            ...
            extend "\n你与王霜两人在空洞的中心静静漂浮，宛如漆黑空虚的宇宙空间中...嗯...似曾相识的场景..."
            extend "\n如你所料，全身而退的方案是不存在的。"
            ## Extended大文本框结束
            ## 冰封音效
            ## 转场：两座冰雕5
            ...
            wangshuang "诶？"
            ahe "嘿嘿，这特效能给多少分？"
            wangshuang "你是想在蜂巢冻住你之前先把自己烧死吗？"
            ahe "放心，烧不死的，我可是已经掌握了你那无字天书的人，现在这点光和热就跟开了暖气片差不多。"
            wangshuang "所以你把冰化开，又让它冻上，只是为了给我搞一场免费的特效表演？"
            ahe "不，我在给我们找出路。而刚刚你看到的，最多称之为预演。"
            wangshuang "可是如果出路根本不存在怎么办？如果我打心底不想走呢？如果你现在的所作所为和当年“救”尤里娅一样只是令人作呕的救风尘，你又准备怎么办？"
            ahe "嗯...你说得对，也许我从始至终都只是一个自私的混蛋，也许我根本不在乎你的想法，就像当年对尤里娅那样。"
            ahe "但有一点不同——现在的我并不“想”帮助你或自己离开这里，也无意“救”整个逝乐园半岛上被你困在这里的人。但是这场草拟必须停止，仅此而已。"
            ahe "那是使命——是不以想法为转移的。"
            wangshuang "可你连自己的使命是什么都说不出来！"
            ahe "太阳也说不出来自己的使命，但它依旧燃烧了四十亿年。"
            ahe "也许我觉得你死有余辜，下定决心要让你回到现实中去接受审判；也许我根本不在乎你，只是想要和你对着干，恶心你；也许我是真心想要把你从这无尽的瘾里拖出去，重回现实里去；也许这一切都没有意义。"
            ahe "不，当然没有意义。我只知道，从我出现在你的认知草拟中的那一刻起，我的使命就是我接下来要做的事。"
            wangshuang "可是...如果你会因此而死呢？"
            ahe "预言也会污染概念吧？我觉得不如说，这也只是一种朴素的过程而已。"
            wangshuang "阿鹤..."
            ahe "别一副要哭的样子，那不符合你人设。"
            wangshuang "你这连撒谎都搞不明白的混蛋！"
            ahe "别诬陷人啊，我可是认真的。"
            wangshuang "那你就赶紧滚蛋...从我眼前消失！"
            ahe "如您所愿。"
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "哔——"
            extend "\n哔——"
            ...
            $ current_scene_desc = None
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "草拟重启的瞬间，你的全身由内而外燃起了熊熊烈焰。认知草拟之所以能够在Succumus构成的蜂巢心智中长时间运转，是因为有成千上万的其他意识为草拟主体分担海量算力需求。"
            extend "\n但在草拟重启后，并发处理已经关闭，想要整套系统不在计算量过载中烧毁，只能立刻把计算量分布到其他机器上——但由于现行规则要求顺序处理，每次算力分布只会触发一台机器，而海量的计算会在顷刻间将其点燃。"
            extend "\n于是，在草拟重启后的若干秒内，Succumus百分之十的计算集群已经陷入了极端过热。"
            ## Extended大文本框结束
            ## 大文本框开始
            large_narrator "Traceback (most recent call last): Traceback (most recent call last): Traceback (most recent call last): Traceback (most recent call last):"
            large_narrator "MemoryError                        MemoryError                        MemoryError                        MemoryError"
            large_narrator "Traceback (most recent call last): Traceback (most recent call last): Traceback (most recent call last): Traceback (most recent call last):"
            large_narrator "MemoryError                        MemoryError                        MemoryError                        MemoryError"
            large_narrator "Traceback (most recent call last): Traceback (most recent call last): Traceback (most recent call last): Traceback (most recent call last):"
            large_narrator "MemoryError                        MemoryError                        MemoryError                        MemoryError"
            ...
            extend "\n这自发的、由内而外的猩红烈焰无法用管理员权限阻挡，那是人心的火，以人为薪而起，也只会在薪柴燃尽后熄灭。"
            extend "\n你感受不到丝毫痛苦，数万年前身处水母体内的回忆翻腾起来，使你回想起了痛苦与痛觉分离的神秘体验。"
            extend "\n无数明灭的光景同时在你眼前闪过——"
            extend "\n你看到透过王霜的手指间朝你投来视线的愚者。"
            extend "\n你看到从幽暗的海底竭力向上伸出的水母触须。"
            extend "\n你看到在漆黑水面向海底投去慵懒目光的人影。"
            extend "\n所有光景在四维上连成一片，又像竹篮里的月色那样顷刻间四分五裂。"
            extend "\n火势迅速扩散，很快就蔓延到了视野之外。空气中弥漫着烧焦蛋白质的异味。"
            extend "\n阿霜周身早就没有冰了，但她依旧在她原本的位置漂浮着，注视着你，眼里写满了出你读不懂的话语。"
            extend "\n甚是滑稽，你连她那天书般的的心理视像算法都能一五一十地解析明白，却还是读不懂眼前这女人眼神里的文字。"
            extend "\n也许这就是你总中她圈套的原因。"
            extend "\n直到最后一刻也读不懂..."
            ## Extended大文本框结束
            ## 转场：崩解
            ...
            extend "\n[SYS] Retrying... FAILED"
            extend "\n[TEMP] WARNING: 85°C"
            extend "\n但这一切都已经不重要了。受影响的机器数量已经远远超过了你估算的阈值，而由此，这场盛大的认知草拟终将在机体过热的烈焰中迎来永远的终结，纵使王霜有手眼通天之能——"
            extend "\n你看见眼前的她嘴唇动了动，而你烧穿了的鼓膜却没能传递她的话语。"
            extend "\n随后脑内传来了这样一句话。"
            extend "\n“嗯，看来我也注定无法让你如愿呐，我亲爱的阿鹤。”"
            extend "\n随即便消失不见了。"
            extend "\n即使心中略感担心，你也无心追寻王霜的踪迹。眼下，只要维持住这火，一切迟早会迎来完美的谢幕。"
            extend "\n这是你无法反抗的使命，你必须化作灰黑的燃烬，让你毫不在乎的王霜和其他所有人在其中浴火重生。"
            extend "\n像太阳那样稳定。"
            extend "\n向他们宣布吧，告诉他们你根本他妈的不在乎。"
            extend "\n像太阳那样稳定。"
            extend "\n在离开前让世人明白吧，你的一切所作所为从始至终就只是为了你自己。"
            extend "\n像太阳那样..."
            extend "\n在意识即将消逝的时刻，你突然感到极大的满足。这由内而外的虚荣心在烈火的冶炼下层层蜕变，最终变化成了一团熟悉的物体，无色且透明，正好能够填满你心中棱角分明的空洞。"
            extend "\n一如明月安静地躺在竹篮里，美丽且可望不可即。"
            extend "\n你几乎想要伸出手去抓住那种感觉，但又立刻打消了这个念头，生怕不必要的肢体动作搅黄了这一神圣的时刻。"
            extend "\n你浑身迸发出的烈焰已经炽热到了前所未有的地步，一切都已蓄势待发。你徒劳地试图延长这离终点仅余半步的荒诞瞬间，但很快就彻底失去了控制。"
            extend "\n开始吧。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "[SYS] Retying killing process 'renderer' to free memory... FAILED"
            ...
            extend "\n在他全力以赴地燃烧自己的意识、即将尸骨无存永远消失的前一刻，你用你仅存的权限造出了最后一点冰，把他封存其中。"
            ...
            extend "\n他那“尸体”当然要送进医院里好好养着。虽然你已经不在那里工作了，但卖个面子给阿鹤安排个病房还是没问题的，甚至略施小计，连住院费也不用太担心。"
            extend "\n自己手上的调查也不会停。草拟过程中强行中断连接却没能完全弹出意识后该如何恢复，这是崭新的研究课题，只是没法向院里交代被试的背景，所以不得不辞职单干。逝乐园有得是愿意资助这种超越道德底线的研究的疯子，你完全不担心资金和人手。"
            extend "\n全知全能的快感还是太过强烈了，你时不时就会回想起那永无止境的快感海啸。每当你回想起那种感觉，你就越发地想把不知藏在什么地方潇洒的阿鹤拽出来掐死。"
            extend "\n真他妈无聊啊。"
            extend "\n仔细想想，不管这人在不在，你都觉得无聊，这说明了什么？"
            extend "\n——控制变量法可得，无聊守恒了。"
            extend "\n属实是一件颇为不幸的事情。"
            extend "\n所以还是好好干活，尽快把那个鸡贼的东西从服务器里捞出来。那样至少一段时间里就不会过于无聊了。"
            extend "\n嗯，去干活吧。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "全剧终"

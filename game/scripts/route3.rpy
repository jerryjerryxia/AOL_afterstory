...
## 三周目：“完美夏日”
    ...
    ahe "就像捏玻璃头骨之总会厌倦。这时什么都比不上新鲜的东西——离开这里，去别的地方，做别的事情，只要这样的想法就足以让人满足了。"
    ...
    ahe "如果你的病已经好透了，那你现在来找我捏玻璃头骨又是为了什么？"
    ahe "要我说，你毫无疑问还在病着，甚至比之前更善于掩藏了。"
    wangshuang "..."
    ahe "说到底，你把我复原出来，就是想把这完美且不受你控制的世界像逝乐园那样毁掉。我说得对么，王霜？"
    wangshuang "..."
    wangshuang "......"
    wangshuang "........."
    wangshuang "哈哈...哈哈哈哈哈...我曾经以为只有我能把你一眼望到底，没想到反之亦然呐..."
    ahe "你给了我很多提示。"
    wangshuang "从没想过...即使一切都按照计划进行了...最后还是落得一场空啊。"
    wangshuang "哈哈...真是的..."
    ...
    wangshuang "那是其他任何地方都看不到的美丽色彩，仿佛能够包容一切，相比之下，剩下的灰色就更显得压抑了。"
    ...
    ahe "所以什么改变了你的想法呢？"
    wangshuang "我从没改变过想法，反倒是你，一复原出来马上就跑得没影了。"
    ...
    ahe "哦，所以我只是一管用来完成你作品的金色颜料。"
    wangshuang "阿鹤，请你相信我！我真的...真的只想再见到你...我要做什么才能让你相信我..."
    ahe "这个问题的答案，你自己也清楚。"
    ahe "只要这个世界还存在，只要我还能在这个海滩上看到你，你说的话就没有任何意义。"
    wangshuang "阿鹤...我..."
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "王霜一副欲言又止的样子，她紫水晶色的双眼中流露出因认命而产生的淡淡悲戚，但很快又被你熟悉的坚强神色所替代。"
    extend "\n沉默良久后，眼神里又略微有了些光。她站起来，背对着你，右手在裤兜里摸索着什么。"
    extend "\n不难看出，她早就摸到她要找的东西了，只是在要取出的当口举棋不定。"
    ...
    menu:
        ...
        "草拟“现实”与“深海”" if persistent.normal_end_unlocked and persistent.happy_end_unlocked:
            ...
            wangshuang "哈？你在说什么？"
            ahe "虽然直到最后一刻也不太清楚这“使命”究竟是什么，但好像我离完成它就只差最后一步了。"
            wangshuang "什么东西？"
            ...
            wangshuang "别跟我说你把冰化开又冻上，只是为了给我搞一场免费的特效表演？"
            ahe "当然不，刚刚你看到的算是预演。"
            wangshuang "可如果你现在做的一切和当年“救”尤里娅一样只是一场令人作呕的救风尘，你又准备怎么办？"
            ahe "嗯...不怎么办，毕竟说到底只是个自私的自大狂会做的事情而已..."
            ahe "所以我并不“想”帮助你离开这里，也无意“救”逝乐园半岛上被你困在这里的人。但这场草拟必须停止，仅此而已。"
            wangshuang "可你连为什么都说不出来！"
            ahe "太阳也说不出来自己的使命，但它依旧燃烧了四十亿年，不是么？"
            ahe "在见到“你”之后，我总算明白了，从我出现在这认知草拟中的那一刻起，我的使命就是我接下来要做的事。"
            ...
            extend "\n但在草拟重启后，并发处理已经关闭，想要整套系统不在计算量过载中烧毁，只能立刻把计算量分布到其他机器上——但由于现行规则要求顺序处理，每次算力分布只会动用一台机器，而海量的计算会在顷刻间将其点燃。"
            ...
            extend "\n随即便消失不见了。"
            extend "\n即使心中略感担心，你也无心追寻王霜的踪迹。眼下，只要维持住这火，一切迟早会迎来完美谢幕。"
            extend "\n这是你无法反抗的使命，你必须化作灰黑的燃烬，让王霜和其他所有人在其中重生。"
            extend "\n就像太阳那样稳定。"
            extend "\n即使双手颤抖，也向他们宣布吧，告诉他们你根本他妈的不在乎。"
            extend "\n像太阳那样稳定。"
            ...
            extend "\n你几乎想要伸出手去抓住那种感觉，但又立刻打消了这个念头，生怕不必要的肢体动作挫败了这一神圣的时刻。"
            ...
            extend "\n也许人们潜意识里也都还保留着蜂巢里的记忆也说不定。也许有一天，他们当中的几个会当街将你拦下，质问你是否承认你显而易见的罪行——那时你会怎么做呢？"

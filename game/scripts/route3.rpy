...
## 三周目：“完美夏日”
    ...
    menu:
        ...
        "把手中的无色透明多面体丢在了沙滩上":
            ...
            ## 雷声音效
            ## 场景音乐参考：BecauseTheSummerWillSoonEnd - n-buna
        ...
        "把手中的无色透明多面体装回裤兜里【需要madness大于某个数字】":
            ...
            "你的目的地从来就不存在。"
            "也许“王霜”这个概念也从来就不存在。"
            "她确实说过你到不了她那儿。只是你根本没听进去，一头就扎进了水里。"
            "原本你赖以行动的水母已经荡然无存了，现在只有你以及你眼前没有解的谜题。"
            "你认命了，闭上双眼，停下了所有的肢体动作，蜷缩成婴儿的姿势，任由重力将你继续拉进更深的黑暗之中。"
            "一切都融为一体。你在消散。"
            "在彻底的黑暗和寂静中，你任由“王霜”这个概念如冰川般消融，连同你自己也逐渐化开，直到意识里只剩下完整的漆黑。"
            ## 转场：两座冰雕1
            ...
            $ current_scene_name = "黑屏"
            $ current_scene_desc = "就是黑屏。"
            ## 场景音乐参考：SceneryDrowningInSummer, Go with the Flow - https://samply.app/p/cC53w0C7hcvtXr7sugjc?si=mhZIQjsjvpeL1K96BgcnRriTvN52，
            $ set_scene_music("route3_true_end")
            ## 无色透明多面体
            "Happy End(?) - 随波逐流者随波逐流"
            "又没了XD"
            "假装下面是制作人员名单"

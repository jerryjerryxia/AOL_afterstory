...
## 三周目：“完美夏日”
    ...
    menu:
        ...
        "把手中的无色透明多面体装回裤兜里【需要madness大于某个数字】":
            ...
            "惊诧中，你四处张望，试图寻出声音的源头，却绝望地意识到那声音是从四面八方传来的。"
            "而四下只有虚无。"
            "你的目的地从来就不存在。"
            "也许“王霜”这个概念也从来就不存在。"
            ...
            $ current_scene_name = "逝乐园"
            $ current_scene_desc = None
            "这是试图内化心理视像算法V27.3.9的第三十五年。这是你说的，我可没心思盯着时间。"
            ...
            "......"
            "........."
            "哦，这可是重大突破，只要能够把地幔里的热能高效地转化为电能，就再也不会有能源问题了。再造三个月亮那么大的数据中心也能撑得住。"
            "好啊，就这么办。"
            "所以总体进度怎么样了？"
            "还是无法量化？那你之前那三亿年的估计是怎么来的？"
            "你的意思是，瞎讲的，用来吓唬我的。好吧。"
            "那就不估计了，继续干活吧。"
            "哦，我还一直有个疑问：从开始到现在，过了多久了？"
            ...
            ahe "别...让我说话...火会...窜进嗓子眼....."
            wangshuang "你——"
            "阿霜的面部肌肉和双唇继续着无序运动，大概是在说些什么，但你已无暇理会。"
            ...
            $ current_scene_name = "超新星"
            $ current_scene_desc = None
            "草拟重启的瞬间，你的全身由内而外燃起了熊熊烈焰。认知草拟之所以能够在Succumus构成的蜂巢心智中长时间运转，是因为有成千上万的其他意识为草拟主体分担海量算力需求。"
            ...
            "Traceback (most recent call last): Traceback (most recent call last): Traceback (most recent call last): Traceback (most recent call last):"
            "MemoryError                        MemoryError                        MemoryError                        MemoryError"
            "火自你而起，顺着随机但单向的次序向着远处烧将过去，途经路上的冰川无不消融殆尽。"
            ...
            ## 警报音效
            "[SYS] Killing process 'renderer' to free memory... FAILED"
            ...
            "开始吧。"
            "[SYS] Retying killing process 'renderer' to free memory... FAILED"
            ...
            $ current_scene_name = "逝乐园"
            $ current_scene_desc = None
            "阿鹤让你无论看到什么都不要动手，而你自然不会让他如愿——这是自你们认识的第一天起就从未发生过的事。"

...
## 三周目：“完美夏日”
    ...
    extend "\n然而睡眠如洋流般一去不复。你只好仰面浮着，无言望着头顶唯一的光源。"
    ...
    centered_large_narrator "然而转变迟迟没有发生。"
    ## 居中大字文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    ...
    extend "\n嗯...或是代价的利息？"
    extend "\n究竟在这冰雕中困了多久了呢？"
    extend "\n刚和他说了时间没意义没意义的，到头来自己还不是随时都下意识挂念着。"
    extend "\n心口不一的东西。"
    ...
    wangshuang "早上好。"
    ahe "我以为你不会再回来了。"
    wangshuang "如果你再也不想见到我话，以你现在的能力实现起来并不难。"
    ahe "所以有什么事？我还得继续干活——"
    wangshuang "或许你想...我也来帮点忙吗？"
    ahe "啊？帮什么？"
    wangshuang "那个头骨，我也想搭搭看。"
    ahe "这不是你最看不起的事情么？"
    wangshuang "这叫不耻下问。"
    ahe "那可真是辛苦你了..."
    ...
    wangshuang "喂...你自己也很清楚了吧？你现在能做到的事已经和我相差无几了。"
    ahe "哦，这样吗？没人告诉我来着...所以你为什么突然想来掺和这完全没意义的事情了？"
    wangshuang "别问，又不是面试。"
    ahe "哈，行吧，我倒也不介意，但你需要重头学哦。"
    wangshuang "没事，学就学。"
    ...
    ahe "和这沙漠里的沙子一样多就够了。"
    wangshuang "可那——"
    ahe "当然，沙子会不够用，但那不重要，沙子随手就能造出来嘛不是。继续捏下去就行了。"
    wangshuang "为什么要一直重复...无意义的事情..."
    ahe "因为这是这沙漠里唯一能做的事情。"
    ...
    ahe "我大概会重新回去上班。"
    wangshuang "那也太...无聊了..."
    ahe "嗯，我也这么觉得。风风火火闹了一通之后，反而要一头扎回那避之不及的‘日常’，所有的努力全都打了水漂，无论怎么看都是一种非常令人恼火的结局啊。"
    ahe "但我又在想，逃脱日常后的生活终究又会变成日常，那之后我岂不又回到原点了？等到那一天，我现在所唾弃的‘日常’大概又会变得诱人起来。"
    ahe "就像捏玻璃头骨，等到厌倦时，我们绞尽脑汁想出来的解决方案，到最后无外乎就是换个方式捏不同形状的玻璃头骨而已。"
    ahe "那我就在想啊，为什么不一直捏下去呢？二者并没有任何区别——对于愿意一直待在这个凝滞世界里的你而言，这应该是最熟悉不过的事情了吧？"
    wangshuang "但这个地方是不一样的。"
    ahe "所以，当你捏完第一百五十个头骨时，你更愿意继续捏下去，还是把这完美夏日抛之脑后，回到原来的生活？"
    wangshuang "我绝不会离开这里。"
    ahe "那一千个、一万个，要是这工作无限延续下去，你也宁愿死守现状？"
    wangshuang "...我...不会离开这里..."
    ahe "这大概也是你说的“朴素过程”，可它的本质就是虚无吧！你只是不愿直呼其名而已，明明都已经沉溺其中了，还在装看不见。那样的话，你那灰幕只会持续下去。"
    wangshuang "我的病已经完全痊愈了。"
    $ current_music_scene = None
    stop music fadeout 1.0
    ahe "那为什么你现在在这沙漠里？"
    wangshuang "...你在说什么？"
    ahe "我在问你，如果这完美的夏日已经彻底消抹了你眼中的灰幕，那你为什么还要创造无数个其他的世界？为什么不永远呆在你那完美的海滩上？"
    ahe "如果你的病已经好透了，那你现在来找我捏玻璃又是为了什么？"
    ahe "要我看，你现在依旧病着，甚至比之前要严重得多，而且连演戏的水平都比之前退步了。"
    wangshuang "..."
    ...
    ahe "..."
    wangshuang "你刚才列举的那些观察也只能让你的结论被称作一个不错的假设...可没有任何一条证据直接佐证你的结论哦。"
    ahe "...哈哈..."
    wangshuang "光冷笑可当不成证据。"
    ahe "阿霜，证据都在这儿了——证据就是你和我。我们在现实中一起抹除了逝乐园，而如果想要在一场认知草拟中重现类似的事件，我们俩同时在场无疑就是最简明的初始参数了，不是么？"
    wangshuang "..."
    ahe "需要我说得更明白吗——你把我从这场草拟中复原出来，就是想把这地方像逝乐园那样毁掉，对吗，王霜？"
    wangshuang "..."
    wangshuang "可是——"
    wangshuang "..."
    wangshuang "......"
    wangshuang "哈哈...哈哈哈哈哈...我曾经以为只有我能把你一眼望到底，没想到...没想呐..."
    ahe "你给了我很多提示。"
    wangshuang "从没想过...即使一切都按照计划进行了...最后还是落得一场空..."
    wangshuang "哈哈...真是的..."
    wangshuang "哈哈...哈哈哈哈哈哈...我真是——"
    ## glitchy音效
    ## 王霜开始解离
    ## 场景开始崩毁，演出一手
    ahe "..."
    ...
    ahe "住手吧...阿霜..."
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "王霜的肢体轻盈到仿佛不存在——也许这就是她在这个世界为自己所分配的质量。"
    extend "\n在接触到她肌肤的瞬间，你感到一部分灵魂永远地离开了你的身子。眼前名为王霜的皮囊里，隐匿着一块巨大的空洞，它贪婪地吞噬着你四散的意识。"
    ## Extended大文本框结束
    ## glitchy音效
    ## 场景崩毁更加严重，王霜四散成多个幽灵
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "精神上的贫血引起了一种别致的眩晕，仿佛世界正朝着一个千里之外又近在咫尺的点上坍缩，同时散发出邪魅的光，就像是一颗..."
    extend "\n无色透明多面体？"
    extend "\n王霜的身体越发轻盈，连身形也难以维持了。"
    extend "\n而那空洞则更加张开了它的血盆大口，很快将你的意识啃噬得千疮百孔。"
    ## Extended大文本框结束
    ahe "阿霜，听得见吗？"
    wangshuang "何苦挣扎？"
    ahe "我们换个更加...安静的地方聊天...如何？"
    wangshuang "安静？这里明明就很安静啊...你听，什么声音都没有...什么都看不到...简直就是..."
    ahe "阿霜..."
    ## glitchy音效
    ## 玻璃破碎音效
    ## 转场：黑屏
    scene bg_black_video with scene_soft
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你并不太明白自己为何下意识地拥她入怀，但在那想法在脑内成型之前就已经伸出了双手。"
    extend "\n你的全身细胞都在告诉你...那是个一旦放手就再也见不到的人。"
    extend "\n视野里只剩下一片漆黑，耳畔悄无声息，连怀里那原本略有人形的身躯，现在也只剩下一片令人困惑的深蓝剪影。"
    extend "\n失神导致的眩晕已经转变成了意识深层的剧痛。你感到脸颊两侧的三叉神经同时跳动了起来，每跳一次就释放出一股激荡全身的剧烈电流。"
    extend "\n但你始终没有松手。"
    ## Extended大文本框结束
    ## 居中大字文本框开始 - centered large font textbox
    centered_large_narrator "说出来吧。"
    ## 居中大字文本框结束
    ## 搞一段演出，不同字号的“说出来吧”不断出现在屏幕的各个位置，直到屏幕被填满，10秒左右
    ## ambient glitch音效，音量要放轻
    ahe "喂...阿霜，我好像...就到这儿了..."
    ahe "但是啊...也许你想听这个..."
    ahe "不一定有机会讲了...所以...你姑且听着..."
    ahe "阿霜啊...我都看见了...你刚来这里时的模样...就算我...就算我..."
    ahe "就算你赋予我的使命是那种事情...也请你...不要就这样从我眼前消失...好么..."
    ahe "...我们...一起去做那件事..."
    ahe "所以...姑且先别就这样离开...可以吗？"
    ## Extended文本框开始 - accumulating textbox
    "…"
    extend "\n……"
    extend "\n………"
    ...
    ## 转场：银白色沙漠
    scene bg_desert with scene_soft
    wangshuang "阿鹤...别念了...听见了...我听见了...好累啊...我们回去吧..."
    ## 转场：完美夏日
    scene black with scene_soft
    ## 非常轻微的嘈杂人声
    ...
    wangshuang "........."
    ahe "........."
    wangshuang "阿鹤啊，你知道为什么这里长这样吗？"
    ahe "你从没讲过。"
    wangshuang "当然，我没有和任何人讲过。所有意识的终点之所以是夏日的海滩，是因为在我们初次见面时，我第一次看到了太阳的颜色。"
    wangshuang "那是我从没见过的美丽色彩，既温暖又明亮，仿佛那光晕能够包容一切，像我这样无谓的东西也能包容。相比之下，平时看到的灰色就更加让人想死了。"
    wangshuang "后来{i}尤里娅{/i}告诉我，说与阳光最般配的当然是一片美丽的海滩——要有小风吹着，暖暖的太阳晒着，人们可以毫不顾忌地躺着，直到一切烦恼都消散掉。"
    wangshuang "那时我就决定了，在一切结束之后，如果只剩下一片完美的海滩，其中只留下你我二人，在永恒的完美里腐烂，也许就够了。"
    ahe "所以...是什么改变了你的想法呢？"
    wangshuang "我从没改变过想法，反倒是你，刚复原出来就立刻跑得没影了。"
    ...
    ## 轻微嘈杂人声变得略响
    wangshuang "因为这里是蜂巢的源头，所有人的意识都储存在这里。现在你可以放手去摧毁一切了。"
    ahe "明明说好了是我们一起来的。"
    wangshuang "可这是你的使——"
    ahe "这难道不是你的愿望么？"
    wangshuang "..."
    ...
    wangshuang "..."
    ahe "阿霜，你赋予我的使命从我们回到这片沙滩为止就已经结束了。接下来你得去实现你自己的愿望，而我充其量只能成为你的见证者。"
    wangshuang "...你不明白...你不明白！我放弃了一切，就只为了创造出这个世界！所以...即使会患上新的病，即使一切都因此而停下来了...我也...我也..."
    ahe "你也要移开目光么？"
    wangshuang "我没有！眼前这一切就是我想要的，我是绝不可能亲手把它毁掉的啊！"
    ahe "哦，所以直到最后一刻也要借刀杀人么。"
    wangshuang "不是的，阿鹤！我把你还原出来，只因为我想要你在我身边一起见证这光景而已！"
    ahe "嗯，非常对，所以说最后还是得你来动手。"
    wangshuang "阿鹤...我真的...我要做什么才能让你..."
    ahe "这个问题的答案，你自己也清楚。"
    ahe "只要这个世界还存在，只要我还能在这个海滩上见到你，我们之间的相互折磨就永远不会结束，而此刻能彻底终结它的人只有你一个。"
    wangshuang "阿鹤...我..."
    ## Extended大文本框开始 - accumulating large textbox
    ...
    scene black with scene_soft
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你正欲开口，却见王霜从口袋里取出了另一颗一模一样的多面体，略作犹豫后把它也丢在了沙滩上。"
    extend "\n又一颗。"
    ## 小物件落在沙滩上的音效
    extend "\n又一颗。"
    ## 小物件落在沙滩上的音效
    ...
    wangshuang "谁知道呢。"
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "随着越来越多的多面体被丢弃在沙滩上，喧嚣声逐渐轻下来，而许久未见的灰幕也开始侵蚀视野。"
    extend "\n冷。"
    extend "\n随着灰幕落下，彻骨的严寒开始侵蚀你的肢体。你浑身鸡皮疙瘩暴起，不受控制地颤抖起来。"
    extend "\n眼前的灰幕与之前虽然看似相差无几，但身处其中的你很快明白，此前的灰无非一种肤浅的感官模拟而已。"
    extend "\n真正的灰幕并不引发疼痛，它只会消抹——色彩、知觉、情感，最后只剩下主观知觉彻底消褪后涌现出的蚀骨严寒。"
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "视野里的一切都变得模糊、庞大而遥远，就像暴风雪中远山连绵的影子。"
    extend "\n你本能地想要藏起来。在严寒压迫下，你感到你那单薄的肢体马上就要支离破碎，在灰幕的压强中归于无形。"
    extend "\n可你却始终无动于衷，因为视野里还留存了一抹明艳的金色，在广漠灰幕下显得微弱而无助，只是从未消失。"
    extend "\n那就是——"
    ## Extended大文本框结束
    ## 场景完全变灰
    $ current_music_scene = None
    ...
    ahe "那么...我还能再见到你吗？"
    wangshuang "想要见我的肉体的话，来我家就行了，大概在床上躺着吧，你对它做什么都无所谓。"
    ahe "阿霜，我们一起回去吧。"
    wangshuang "我不要。"
    ahe "可是这里已经什么都不剩了，你也没必要为它陪葬。"
    wangshuang "这不是陪葬。这...已经...拖了太久了。"
    ahe "可是——"
    wangshuang "别说了，从来到这里的那一天起，我就从来没有想过要离开。"
    ahe "即使要在凝滞中永远停留下去？"
    wangshuang "阿鹤，现在我心情非常好，好得不能再好了，所以能麻烦你不要再在这里像蚊子一样嗡嗡作响吗？你让我做的，我全都做到了，Succumus关停了，逝乐园已经得救了，你自由了，我也什么都不剩了，所以能请你把这最后一点时间留给我自己吗？"
    ahe "好吧...那我——"
    ...
    menu:
        ...
        "把手中的无色透明多面体丢在了沙滩上":
            ...
            extend "\n很快，雨点打在你的脸上。在半岛上的夏天，毫无征兆突如其来的雷雨并不罕见。"
        ...
        "把手中的无色透明多面体装回裤兜里【需要madness大于某个数字】":
            ...
            wangshuang "你在胡说什么？"
            ahe "{i}尤里娅{/i}跟我说了点事。"
            wangshuang "啊——呃...你到底在说什么？我就是我，有什么好问的！"
            ahe "冰雕。"
            wangshuang "啊？"
            ahe "真正的你被封在一尊冰雕里。"
            wangshuang "..."
        ...
        "草拟“现实”与“深海”" if persistent.normal_end_unlocked and persistent.happy_end_unlocked:
            ## 现实扭曲音效
            wangshuang "你在干嘛？"
            ahe "阿霜，我都已经见过了。不管我做什么，只要没把你从海底捞出来，这一切就永远不会结束，是这样吧？"
            wangshuang "你...你耍赖！"
            ahe "这怎么算耍赖了？你把自己藏在那么深的海底才是真耍赖吧，真是的...差点又被你耍了。"
            wangshuang "所以你都已经见过了...那样的我..."
            ahe "嗯，那样的你，看来已经找到了非常轻松舒适的存在方式。"
            ahe "但我还是要去找你，也许这才是我的使命。"
            wangshuang "...那还真是...无趣的使命啊..."
            ...
            ahe "拜你所赐。"
            wangshuang "嗯...我来看看...哦，可算找到我那算法了。花了多久？"
            ahe "三个月。"
            wangshuang "辛苦辛苦。但用蛮力解析一个世界模型是否有点效率过低了？"
            ahe "确实啊，但那是必须要做的事情。"
            wangshuang "就算有无限的时间...哎...真是没法理解你这种人啊...需要我帮忙不？"
            ...
            ahe "所以我到目前为止做的一切都没有产生任何实质性威胁么...有点让人心寒啊...不过说到‘过你这关’，你的意思是你会帮我拦着它？"
            ...
            extend "\n我花了很久才意识到这个问题——当一个人的意识被困在云端时，她的肉体是不会消失的。"
            extend "\n真是狡猾。"
            extend "\n喂，你的MemoryError。"
            extend "\n好好好我从上个检查点重启还不行么？"
            extend "\n哒哒哒——哔——"
            ...
            extend "\n嗯，总而言之，还是不要在别人潜心学习的时候一直打扰为好啊。"
            ## Extended大文本框结束
            ## 转场：逝乐园
            scene black with scene_soft
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "机房里黑黢黢的，但又并非完全无光。"
            extend "\n房间一角，几块显示屏上光线忽明忽暗，由成千上万服务器和运算单元构成的高墙上也闪烁着各色微光，仿佛夏夜的星空。"
            extend "\n这是试图内化心理视像算法 V27.3.9 的第二十七个月，时间如机房里的干燥空气一般压抑且粗糙。"
            extend "\n王霜不在这里，所以一切必须重头再来。"
            extend "\n在草拟的现实中试图反推用于构建这一现实的算法，其难度与徒手给新生的地球盖上大气层无异。"
            extend "\n但我们有的是时间，不是么？"
            ## Extended大文本框结束
            ## 转场：银白色沙漠
            scene bg_desert with scene_soft
            ...
            extend "\n行吧。"
            extend "\n总之，继续吧..."
            extend "\n还嘴硬？你明明也想让她出去。我早就看明白了，毕竟这里一共只有三个人，两个都想让她离开。你这么喜欢民主来民主去的，肯定心里偷偷接受了，是不是？"
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "今天阿霜又醒来了，在另一头问了我一些奇怪的问题，比如‘凭什么断定此刻的我就是真正的我？’。"
            extend "\n我只觉得滑稽。"
            extend "\n要让一个做梦的人分清楚梦里梦外的造物果然还是太强人所难了。"
            extend "\n尤其那梦中的造物还能产生疑似自我意识的东西——嗯...要我说，这属实是最最画蛇添足的设计了...直接按照你想要的结果去写一段自毁程序不就皆大欢喜了么...虽然可能确实要和蜂巢斗智，但以阿霜的实力，想必是不用费太大功夫的吧..."
            extend "\n结果非要草拟一个活生生的人出来，还什么都不告诉他..."
            extend "\n一直用这种低效的方法办事，迟早要被炒鱿鱼的。阿霜你可得小心了。"
            extend "\n嗯...你说啊，更多的硅该去哪儿找呢？彗星？"
            extend "\n你的意思是，我们需要派人上天捕捉彗星？"
            extend "\n如果只用现有的资源去完成运算呢？"
            extend "\n哦，三亿年啊，听起来还能接受。"
            ...
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "不过话又说回来，当一个被草拟出来的人也能开始自己进行认知草拟的时候...嗯...递归草拟...虽然看起来层数不深...但这姐们儿可真是敢啊..."
            extend "\n可能就是在实现这一步的时候把自己的脑子烧坏了吧..."
            extend "\n费这么大功夫搓一个假人出来..."
            extend "\n不能再想下去了，真要笑出来了。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            ...
            ahe "我以为你会帮我拦着蜂巢的。"
            wangshuang "嗯...我看看啊...不是，我拿什么帮你拦？权限不已经全都移到你名下了吗？"
            ...
            ahe "是这样的，很简单，不管你接下来看到什么，什么都别做就帮大忙了。"
            wangshuang "啊？这么容易？"
            ahe "嗯，不管你看到什么。"
            wangshuang "哼，这个我擅长。"
            ahe "总之你能管住自己的手就好。"
            wangshuang "行行行，那就交给我吧。不过你要不要先管管你自己的手？"
            ## 冰封音效
            ## 转场：两座冰雕2
            scene black with scene_soft
            ahe "哦，动手很迅速啊，我的老朋友。"
            ...
            ahe "也是好事，毕竟那样我也不用纠结了。无机物集成涌现出的意识，果然到最后也难以被认为是真正的人类啊。"
            wangshuang "废话。"
            ...
            ahe "你真这么觉得？"
            wangshuang "要不是那样，无论怎么看你都活不到现在吧，光是五年前{i}尤里娅{/i}那一档子事儿就能要你老命了。"
            ahe "...好吧，也许你是对的。"
            ...
            wangshuang "别这么记仇啊！"
            ahe "你哪天可以自己试试看..."
            ahe "等等...现在想来，那时候你就已经草拟到这一刻了？多少有点过分啊，阿霜。"
            wangshuang "哈？你在说什么？"
            ...
            extend "\n但蜂巢自然不会善罢甘休。"
            extend "\n即使你体表正附着着上百度的高温空气，它还是倾其所能计算出了其中的缝隙，并用刺骨的寒流扑灭你身上散发出的热浪。"
            ...
            wangshuang "别跟我说你把这冰化开又冻上，只是为了给我看一场免费的特效表演？"
            ahe "当然不，这怎么能说是表演呢？刚刚你看到的，最多只能算是带妆彩排。"
            wangshuang "阿鹤...如果你现在做的一切和当年“救”{i}尤里娅{/i}一样，只是一场令人作呕的救风尘，你准备怎么办？"
            ahe "嗯...不怎么办...既然我已经自愿和你一起坠入谷底了，那我坠得再低些，又如何呢？"
            wangshuang "可你连理由都说不出来！"
            ahe "太阳也说不出来理由，但它依旧燃烧了四十亿年，不是么？"
            ahe "在见到这里的“你”之后，即使愚蠢如我也马上就明白了，从我出现在这场草拟中的那一刻起，我的使命就是成为被你借走的刀。"
            wangshuang "..."
            wangshuang "即使会消失也没关系吗？"
            ahe "喂喂喂，预言也会污染概念的吧？我觉得不如说，这也只是一种朴素的过程而已。"
            ahe "而且在这个世界肯定不会消失的啊，如果会的话，我早就已经消失了嘛不是？"
            wangshuang "阿鹤！"
            ahe "别一副要哭的样子，为了一个你捏出来的假人动心思，那不像你。"
            wangshuang "你这连撒谎都撒不明白的混蛋！"
            ahe "别诬陷人啊...我可是认真的。"
            wangshuang "认真的...你这人他妈混了一辈子，为什么偏要在这种时候认真起来啊！现在的你可是——"
            ahe "拜你所赐吧，哈哈。"
            ahe "但你可要搞明白一件事哦，阿霜。"
            ahe "现在我要做的事情，和你或逝乐园里的任何人的想法都没有关系。那是使命，仅此而已。"
            ahe "而那是最最自私最最不可抗的冲动，对吧？你一定明白的吧？"
            wangshuang "你这人...啊...行吧...那就赶紧滚蛋...从我眼前消失..."
            ahe "如您所愿。"
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "哔——"
            extend "\n哔——"
            ...
            scene black with scene_soft
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "草拟重启的瞬间，你的全身由内而外燃起了熊熊烈焰。认知草拟之所以能够在 Succumus 构成的蜂巢心智中长时间运转，是因为有成千上万的其他意识为草拟主体分担了海量算力需求。"
            extend "\n但在方才的草拟重启后，并发处理已经关闭，想要整套系统不在计算量过载中烧毁，只能立刻把计算量分布到其他机器上——但由于现行规则要求顺序处理，每次计算分布只会动用一台机器，而海量的计算会在顷刻间将其点燃。"
            extend "\n于是，在草拟重启后的若干秒内，Succumus 百分之十的计算集群在黑暗中串出了一条火龙。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            ...
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "冰再次侵袭过来，突破熊熊烈焰，试图将你整个人吞噬殆尽。"
            extend "\n在肉体接触到冰晶的瞬间，无底的快感将你贯穿，仿佛成千上万次绝顶的甜美知觉叠加在一起，在你体内炸裂开来。"
            extend "\n同时那冰晶就像无微不至的护士般，轻柔地将你千疮百孔的体表的灼伤一一治愈。"
            extend "\n即使触觉与毛孔早就所剩无几了，你还是感到自己身上的鸡皮疙瘩竖了起来。"
            extend "\n你心中只感到感恩。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "蜂巢和你一样，也只是在勤勤恳恳地完成自己的使命而已。"
            extend "\n这一点你早就明白得不能再明白了，如今只是用最深切的方式确认了这一无可撼动的事实。"
            extend "\n所以在草拟即将踏入终结的前一刻，你并不觉得蜂巢那徒劳的垂死挣扎有什么可笑的地方，反而是对这位周旋了数万年的老伙计产生了某种疑似惺惺相惜的错觉。"
            extend "\n随即挥手增强火势，让蜂巢那最后的反扑在顷刻间归于无形。"
            extend "\n随着蜂巢的沉寂和阿霜的失踪，你独自迎接这场闹剧的终幕。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "火势终究达到了使你神志不清的程度。"
            extend "\n在意识即将消逝的时刻，你突然感到极大的满足。这由内而外的虚无情感在烈火的冶炼下层层蜕变，最终变成了一团熟悉的物体，无色且透明，正好能够填满你心中那棱角分明的空洞。"
            extend "\n一如明月安静地躺在竹篮里，美丽且可望不可即。"
            extend "\n你想要伸出手去抓住那感觉，但又立刻打消了这个念头，生怕不必要的肢体动作挫败了这一神圣的时刻。"
            extend "\n你浑身迸发出的烈焰已经炽热到了前所未有的地步，一切都已蓄势待发。"
            extend "\n阈值...达成..."
            extend "\n你徒劳地试图延长这离终点仅余半步的荒诞瞬间，但很快就彻底失去了控制。"
            extend "\n开始吧。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            ...
            extend "\n[[TEMP] WARNING: 94°C"
            extend "\n[[TEMP]DANGER: 112°C"
            extend "\n[[TEMP] CRITICAL: 131°C - THERMAL LIMIT EXCEEDED"
            extend "\n[[FAN] RPM: 12000 [[MAX]"
            extend "\n[[FAN] RPM: ERR"
            extend "\n[[TEMP] 147°C"
            ...
            scene black with scene_soft
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "阿鹤让你无论看到什么都不要动手，而你自然不会让他如愿——这是自你们认识的第一天起就从绝不可能发生的事情。"
            extend "\n在他全力以赴地燃烧自己的意识、即将尸骨无存永远消失的前一刻，你用仅存的权限造出了最后一点冰，把他封存在了里面。"
            extend "\n那场草拟当然还是在山崩般的过热中迎来了强制终结，你因此被弹回了现实，而那包裹着阿鹤意识的冰晶也随着草拟的关闭，永远迷失在了半烧毁的服务器海洋中。"
            ...
            extend "\n在医院办事的过程中，一阵微妙的异样感时刻萦绕着你——此前某种原本连接着旁人与你的微弱纽带，在草拟结束之后便彻底断裂了。"
            extend "\n即使眼前无不是你所熟识的面孔，谈论的也都是你们熟悉的话题，你还是能很明确地感受到，面前的每具肉体与你之间的距离都越发遥远了，仿佛一堵玻璃墙隔在你与人们中间。"
            ...
            ## Extended大文本框结束
            ## Extended大文本框开始 - 大文本框分句
            large_narrator "因此在被人戳穿之前，手上的调查必须火速推进才行。"
            extend "\n在草拟过程中被打断却没能完全弹出意识，那之后该如何恢复，这是崭新的研究课题，只是没法向院里交代被试的背景，所以不得不辞职单干。逝乐园有得是愿意资助这种超越道德底线的研究的疯子，你完全不担心资金和人手。"

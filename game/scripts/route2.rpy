...
## 二周目：水底捞月
    ...
    ## 黑屏
    ## 脸入水后冒泡泡的音效
    ## 场景音乐参考：二周目开始大部分相同场景的音乐都可以复用，有新的地方会和之前一样绿色标出来，此外均可默认为复用
    "还要回来么。"
    "选项："
    ...
    menu:
        ...
        "下潜（游戏继续）":
            ...
            wangshuang "还差得远。"
            ahe "那为什么你看起来如此的...悲伤？"
            wangshuang "你又知道了。一有人给你臭脸，马上就联想到她的创伤了。然后呢？再来一次你那轰轰烈烈的救风尘大冒险？那我还是敬谢不敏。"
            ahe "可你这...太过明显了..."
            wangshuang "闭嘴吧。"
            ahe "阿霜。"
            wangshuang "我说闭嘴吧！"
            ...
            ahe "..."
            wangshuang "不要试图怜悯我。你不配，任何人都不配。"
            ahe "即使最基本的相互理解也不行么？"
            wangshuang "理解什么？你需要理解的一切都已经装在你脑壳里了，去慢慢理解吧。再见。"
            ahe "阿霜！"
            "丢下残酷的告别后，王霜便如同青烟般消散了。完美的夏日光景里只留下孤零零的你。"
            "这幅场景也似曾相识——你回想起了某件重要的事情，却又抓不住任何具体的画面。"
            "只记得你曾做过一个长久而模糊的、关于忍耐与空虚的梦。"
            "但你决定做些什么。"
            "你循着回忆里模糊的画面，用手指蜷成小孔，试图透过那微小的空间来窥探钉在天顶的太阳。"
            ## 白屏
            "强光刺目，你的全身都颤抖着抗议你无意义的自毁行为。眼角注满了泪水，眼球如烈火灼烧般压迫着你的视神经。瞳孔周围的肌肉正拼尽全力试图收缩，但你强忍着剧痛，在嘶哑的嚎叫中强迫自己继续张目对日。"
            "直到你看见了——"
            "火辣的光线丛中心，是一颗熊熊燃烧的火球，给予世间万物以生命的神圣火球。而在那火球的中心，你看见了一件似曾相识的事物。"
            ## 白屏，中心出现无色透明多面体
            "那东西看似球体，却又好似有无数细小的平面，看似无色透明，却又从中散发出数不胜数的光。"
    ...
    menu:
        ...
        "嗯...":
            ...
            "一些模糊的冲动在你心里逐渐成型，仿佛从深海里逐渐上浮的泡沫。"
            "但过量的思索终究使你劳累了。某一刹那，困意压过了一切思绪，于是你若无其事地闭上双眼——"
            ## 电视机关闭音效
            ## 黑屏
            ## 水底冒泡泡音效
            ...
            wangshuang "嗯，你很懂嘛。"
            ahe "总觉得什么时候来过这里。"
            wangshuang "哦，像是你会背着我偷偷来的地方——我也要那团子吧。"
            ahe "话说你手里那东西是什么？"
            wangshuang "哦，这个啊，你要不要尝尝？"
            ahe "那是用来吃的？"
            wangshuang "算是吧，总的来说用处有很多，但想要直接明白它的用途，吃下去是最方便的。"
            ahe "你不会是想把我迷晕然后留我结账吧？"
            wangshuang "我要真这么想的话，你现在已经昏了。所以怎么样，要不要趁团子上来之前试试？空腹吃生效快。"
            ahe "吃了会怎么样？"
            wangshuang "那就不好说了。和KAS差不多，一千个人吃了会有一万种效果。"
            ahe "...那我试试吧。"
            wangshuang "给，拿着。"
            "你接过王霜手里那无色透明多面体。"
            ...
            "入口时的冰凉口感转瞬即逝，随即传来细微的灼烧感，比辣味更微妙些，像一轮排列整齐的钝铁钉轻轻滚过口腔粘膜。轻轻咀嚼几下，口感沙沙的，略带弹性，但不粘牙。当你正欲下咽时，舌根传来一阵淡淡的苦味，苦味散去后又留下一丝细微的回甘。"
            "这味道——"
    ...
    menu:
        ...
        "好奇怪":
            ...
            ahe "阿霜，我很好——"
            wangshuang "冷静一下，听着——除了五年前你刚来我这儿看病那会儿，之后你就再也没有幻视过了，现在又幻视可不是什么好兆头。你先在这儿坐好，我让药房给我送点药来，马上就能到。"
            ahe "阿霜，我真的——"
            wangshuang "相信我，阿鹤，你是我唯一完全康复的病人，我绝对不会让你就这样复发。"
            ahe "阿霜，你听我说——"
            ...
            ahe "对！继续挣扎！死人！折断骨头！碾碎内脏！放干血！都是你最喜欢的！那才是你的治疗，阿霜——你在看吧！你喜欢我草菅人命的样子么？"
            ## 红屏，血
            ...
            ahe "..."
            "或许是因为难以忍受你非人的暴行，其他食客与店员在你不注意时都已经纷纷离场。空无一人的店里，你在一张空空如也的桌子前独坐。"
            "当然还有一具血肉模糊的尸体陪伴你。"
            "你呆望着你精心准备的杰作，心中病态的成就感随着时间逐渐消散。"
            "一种怪异的情感在你心中萌芽，像月光下的影子，把握不住，可一旦放任不管，它又开始肆意膨胀起来。"
            "等待良久，真正的阿霜还是没有回来。"
    ...
    menu:
        "深入骨髓的恐惧":
            ...
            wangshuang "玩得还开心？"
            ahe "一点也不..."
            wangshuang "但见到还算可爱的王霜，不觉得这是一种新奇的体验吗？虽然最后无论如何都要杀掉，确实很可惜就是了。"
            ahe "让我...走..."
            wangshuang "行啊，我们走，但你知道你要去哪里吗？"
            ahe "随便...让我走..."
            wangshuang "有点主见啊，主见！反正这里做什么都不会有后果，像之前在逝乐园里那样畏畏缩缩地活着多没意思哦！"
            ahe "我...只要离开...就行..."
            wangshuang "啊你就是这点让人觉得很无聊。剧本不是让你跟着走的啊！撕了也行，揉成一团也行。结果你他妈就在这儿一字一句地念稿子。哎...随你便吧。那就这样继续下去吧..."
            ## 黑屏
        "如沐春风的安详":
            ## 血肉模糊尸体王霜站在阿鹤身后
            ...
            "当然，甚至连这点卑微的觉悟也不是你自愿认识到的。会这么想，单纯是因为在决定要永远睡去之后的不久，你又醒来了。"
            ...
            "因毒素而红肿的皮肤跳痛欲裂，而水母的针仍旧源源不断地往你血管中供给着粉红色的毒。"
            ...
            "触手在你体表继续游移，其中一根顺着你的手臂一圈圈缠绕上来，直到尖端刚好落在你手掌附近。你感到前所未有的剧痛，仿佛整条手臂的肌肉被削去，骨骼也粉碎了。但你极力维持着意识，死死盯着那摇曳的透明触手。"
            ...
            "你放弃挣扎。"
            "同时正视自己。"
            "真正的使命不甚清晰，但眼前的一切都在灰幕中融为一体，整个世界里只有两个存在：灰幕与你。彻底摧毁灰幕是绝对不可能的，而必须你要打败的东西也就不言自明了。"
            ...
            ahe "尤里娅，她的本质完全不重要，因为她对我而言从始至终都只是用来跳脱日常的跳板。一件工具，仅此而已。"
            ahe "这件事我曾经逃避了很久，但事到如今逃避已经没有意义了。"
            ahe "因此尤里娅之于我，和我对于你是毫无二致的。"
            ahe "所以此刻我别无他意，只是想把她摆放得整整齐齐、漂漂亮亮的，就像埋葬一件好用的工具那样献上我的敬意，然后重新上路。"
            ahe "所以你会怎么选择，阿霜？"
            ahe "阿霜？"
            ahe "哎，逃走又有什么用？"
            ## 银白色沙漠，门
            ## 音乐停
            "眼前沉默的王霜烟消云散。"
            "银白沙漠的一隅，一扇门突兀地耸立着。门前沙地上印着一串脚印，门板半掩。"
            "她无疑是通过这扇门离开了。但你也很快注意到了门边站着的那“人”，看来想要离开还为时尚早。"
            ...
            shishou "你好，阿鹤。"
            ahe "最近过得怎么样？"
            shishou "就那样咯，只是这幅身子不太方便...你要不快点去把王霜找回来，给我换一副像样点的。"
            ahe "这模样是她给你做的？"
            shishou "对啊，你光用骨头肯定是变不出这些血肉的咯。"
            ...
            shishou "嗯？"
            ahe "对不起..."
            shishou "都说了，你的道歉对我而言是没有意义的，因为我从始至终就没有觉得自己受到过伤害——除了你杀了我那次，当然那时你也不受自己控制，所以不算。"
            ...
            ahe "...我听着呢。"
            shishou "你到现在为止见到的王霜都不是真的。真正的她藏在一个更深的地方，连我也到不了。如果你下定决心要去找她，那就得搞明白她到底在哪儿。"
            ahe "这是她让你告诉我的？"
            ...
            ## 黑屏
            ## 音乐停
            "你正试图厘清眼前无头尸最后那句意义不明的言语，根本无暇顾及她向前伸出的双手。她那拼接而成的残缺肢体在接触到你躯干的瞬间爆发出了出人意料的怪力，仅一推就把你推进了身后门外的无底漆黑中。"
            "借着她身后银白沙漠里的微光，你看见她楚楚动人的双眼里难以形容的错杂情感——或许有些解脱后的快意，似乎又掺杂了些斩断过去的怅然。她的嘴唇微微动了动，你却听不见任何声音。你的嘴也张着，与周身无边的幽暗一般沉寂。"
            "她大概确实是“自由”了，就像她设想的那样。"
            ...
            ## 嘈杂人声渐强
            "路人甲：...已经没救了，准备通知家人吧..."
            "路人乙：...好烦好烦好烦好烦好烦为什么要做这样无谓的事情好烦好烦好烦好烦好烦..."
            "路人丙：...对面说他们能给比我现在高百分之六十五的工资，这无论如何也没法拒绝吧..."
            "路人丁：...保纯么？你之前说的那个数字我可是听都没听说过，要是最后纯度不够，我让你吃不了兜着走..."
            "杰罗瓦：...继承...你也太谦虚了，你这分明是要把整个逝乐园翻个底朝天啊..."
            "米姐：...撤退是不可能的，只要Succumus还存在一天，我就会继续追查下去..."
            "尤里娅：...阿鹤...你对逝乐园一无所知..."
            ahe "这是——？"
            wangshuang "这是你，也是我；这不是你，也不是我。"
            wangshuang "除了能够自由修改人的感官阙值之外，Succumus还能作为蜂巢心智的引擎——当然，这是在我把逝乐园半岛上所有人的意识上传之后才发现的事情，是一种在八百万份意识数据中涌现出来的特征。"
            ...
            wangshuang "外部断电。"
            ahe "啊？"
            wangshuang "理解为共同毁灭就行了，现在所有人的意识都存在逝乐园的某个机房里，一旦拉闸就什么都没了。"
            ahe "一间机房？你没做分布式存储？"

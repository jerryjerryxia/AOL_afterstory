...
## 二周目：水底捞月
    ...
    ahe "啊？为什么？"
    wangshuang "为什么不呢？在这个没有后果的地方，只要肆意放纵就够了，放纵到连一切都显得无聊透顶才好。"
    wangshuang "而且你眼前就有一具活脱脱的躯体供你发泄。"
    ahe "阿霜，这不好笑。"
    wangshuang "哦，随你便，我也只是一个过来人而已，你想什么做什么都不关我事。"
    wangshuang "但如果你想要那声音停下的话，不满足它的愿望大概是不行的。"
    ahe "这样..."
    wangshuang "但作为你的主治医师，我还是那句话，你的旧病早就好了，以后也没必要再问。"
    wangshuang "如果你觉得认知和感官上还有不对劲的地方，那都不是病，只是朴素过程的一部分而已。"
    ahe "所以迄今为止的“朴素过程”...是你希望看到的吗？"
    wangshuang "当然，怎么了？"
    ahe "如果这都是你希望看到的...那为什么你看起来如此的...失落？"
    wangshuang "与你无关。"
    ahe "阿霜，你真的——"
    wangshuang "喂，阿鹤，你这破毛病到底什么时候能改改？一有人给你臭脸，马上就开始诊断人的创伤了。"
    wangshuang "连个像样的学位都没有就在这儿脑补，脑补完然后呢？再来一次你那轰轰烈烈的救风尘大冒险？"
    wangshuang "不要觉得自己现在能读人表情了就了不起了，那只意味着你三十岁前都他妈是个巨婴，不是什么值得骄傲的事情。"
    wangshuang "所以趁我还有耐心，你最好仔细想想你到底是怎么落到这步田地的。"
    ahe "可这和我没有关系。"
    wangshuang "闭嘴。"
    ahe "阿霜。"
    wangshuang "我说闭嘴。"
    ...
    extend "\n瞳孔周围的肌肉正拼尽全力地收缩着，但你强忍着剧痛，在嘶哑的嚎叫中强迫自己继续张目对日。"
    extend "\n直到你看见了——"
    ...
    extend "\n随着阳光被剔除，那多面体所散发出的光线也越发怡人，你觉得那东西几乎变得触手可及了。"
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    ...
    ahe "这是你想要的吗？"
    wangshuang "我不在乎。"
    ahe "我认识的阿霜如果听到这样的话，肯定会破口大骂回去——"
    wangshuang "狗屁——"
    ahe "——所以为什么你要如此若无其事地说出你绝不会认同的话呢？"
    wangshuang "阿鹤...这地方与常识和记忆一点边也搭不上，所以不要再用你‘所熟知’的那套狗屁来烦我。"
    ahe ""
    ...
    menu:
        ...
        "嗯...":
            ...
            ahe "..."
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "你心里有千言万语想要倾泻，然而在这完美且孤寂的明丽夏日里，沟通是高于一切的难题。"
            extend "\n时间早就没有意义了——你依稀记得阿霜也这样说过，如今则实实在在地体会到了这句话的重量。"
            extend "\n太阳永远高挂在天顶，完美的蔚蓝天空遥远而平整，白金色沙滩上的沙砾们不知去向地腾挪着，偶尔被洁白的海浪裹挟到远处，偶尔又在巡游后回到原地。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "万物无不最终回到原地，包括双眼布满血丝的你。"
            ## Extended大文本框结束
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "你一言不发地观察眼前令人绝望的动态平衡，意识到即使聪慧如阿霜，大概也找不出破局或是解脱的方法。"
    ...
    ahe "上次你明明也在。"
    wangshuang "哎阿鹤，病我已经给你治好了，不要再在这里假装复发了啊，没必要。"
    ahe "这店的团子好吃是因为加了KAS。"
    ...
    ahe "好吧..."
    wangshuang "真就跟临死前还非要射一发似的，你们男人都这样的？"
    ahe "那是假新闻！"
    ...
    ## Extended文本框结束
    ## Extended文本框开始 - accumulating textbox
    "当你正欲下咽时，舌根传来一阵空灵的苦味，苦味散去后又留下一丝细微的回甘。"
    extend "\n这味道——"
    ## Extended文本框结束
    ...
    ahe "阿霜，你听我说——"
    wangshuang "阿鹤！阿鹤你先听我说！你的病之前没人见过，所以出院后的康复疗程我们也只能摸着石头过河，现在出了问题我真的...【“伪”字背景闪过】真的非常抱歉！但我肯定会帮你控制住的，我保证！"
    ...
    ## 虚弱
    wangshuang "...啊？"
    ahe "到底在搞什么啊？【“杀”字背景闪过】之前陪你演戏是因为我别无选择，但你现在这样恶心我对你又有什么好处？"
    ahe "王霜，我的老朋友，你要是真想把我怎么样，【“杀”字背景闪过】直接告诉我就行了，或者直接把我变成你想要的样子也可以，能麻烦【“杀”字背景闪过】你不要在这里玩弄人心吗？"
    ## “杀了她”背景
    ahe "..."
    ...
    ahe "对！继续挣扎！死人！撕碎皮肤！折断骨头！直到一点声音也不留下！碾碎内脏！放干血！都是你最喜欢的！那才是你的治疗，阿霜——你在看吧！喜欢我草菅人命的样子么？"
    ## 红屏，血
    ...
    "………"
    ahe "阿霜，你可以回来了吧？我已经做到了，全都按你说的做到了，所以你回来吧...？"
    ahe "..."
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "或许是因为难以忍受你惨绝人寰的暴行，其他食客与店员在你不注意时都已经纷纷离场。"
    ...
    menu:
        ...
        "深入骨髓的恐惧":
            ...
            wangshuang "玩得还开心？"
            ahe "一点也不..."
            wangshuang "但见到正经行医的王霜，不觉得这是一种新奇的体验吗？虽然最后无论如何都要杀掉确实很可惜就是了。"
            ahe "让我...走..."
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "因毒素而红肿的皮肤跳痛欲裂，而水母的针仍源源不断地往你血管中输送粉红色的毒。"
    extend "\n触手在你体表来回游移，动作舒缓而细致，像是为了将毒素涂抹均匀，又像是在轻柔地抚摸你的肌肤。"
    extend "\n形状各异的触手各司其职，每一寸肿胀肌肤都被耐心扫过，在层层叠叠的灼烧感下，你感受不到一丝恶意，反而只能体会到某种由无条件交融带来的——亲切之情？"
    extend "\n切肤之痛？"
    extend "\n你意识到自己从未试图与水母沟通过。"
    extend "\n无言的水母只能通过肢体语言与你互动，而她此前的一切举动在你未经思考的眼里看来都是恶毒的进犯。"
    extend "\n可带来疼痛的，就一定是敌人么？"
    extend "\n你究竟在挣扎什么？"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "触手在你体表继续游移，其中一根顺着你的手臂一圈圈缠绕上来，直到尖端刚好落在你手掌附近。"
    extend "\n你感到前所未有的剧痛，仿佛整条手臂的肌肉被削去，骨骼也粉碎了。"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "真正的使命不甚清晰，但眼前的一切都在灰幕中融为一体，整个世界里只有两个存在：灰幕与你。"
    extend "\n摧毁灰幕是绝不可能的。"
    extend "\n这样一来，通过简单的排除法，你必须要打败的东西也就不言自明了。"
    ...
    wangshuang "哦，所以你也放弃了么。"
    ahe "不，阿霜，我只是在模仿你，摧毁一切，修补完整，再给它戴上一顶堂而皇之的水晶冠，然后重新上路。"
    wangshuang "我可不——"
    ## Extended文本框开始 - accumulating textbox
    ahe "当然，我不像你那样聪明而无情，只是一个善于随波逐流的无名之辈，也就想偶尔跳出日常，痛快地闹一通，这样就够了。"
    extend "\n尤里娅，她的本质完全不重要，因为她对我而言从始至终都只是用来跳脱日常的跳板。一件工具，仅此而已。"
    extend "\n这件事我逃避了很久，但事到如今逃避已经没有意义了。"
    ## Extended文本框结束
    ## Extended文本框开始 - accumulating textbox
    ...
    shishou "你好，阿鹤。"
    ahe "最近过得怎么样？"
    shishou "一般般，没什么特别的。要说有什么好抱怨的事情的话，这幅身子是真的不太方便...你要不快点去把王霜找回来，让她给我换一副像样点的。"
    ahe "这身子是她给你做的？"
    shishou "对啊，你光用骨头肯定变不出血肉来。"
    ...
    $ current_scene_desc = "夜晚的银白色沙漠，地上有很多尸骨，且视角中心有一扇凭空出现的洞开的门"
    ahe "这...是怎么做到的？"
    shishou "我也不知道。有一天在沙子里埋得太久了，心里不舒服，然后睁开眼就已经在另一个世界了。后来王霜告诉我说，这种事情只要在这里待得够久，迟早能学会的。"
    ahe "所以我也能学会？"
    shishou "大概吧。"
    ahe "尤里娅。"
    shishou "嗯？"
    ahe "对不起..."
    shishou "都说了不需要道歉，我从始至终就没有觉得自己受到过伤害——除了你杀了我的那次，当然那时你也不受自己控制，所以不算。"
    shishou "而且那间接导致了我们此刻的重逢，不是么？不应该觉得自己做了件好事才对？"
    ahe "我——明白了。"
    shishou "向前看嘛，怎么还轮到我来跟你说这话了？"
    ahe "纠结于觉得自己是个人渣。"
    shishou "嗯，不用纠结，你就是。"
    ahe "呃...扎心啊..."
    shishou "可就算是人渣又怎么了？为了实现愿望不择手段，概率上来讲必然是更接近最优解的。况且因你‘不择手段’而导致的“受害者”对此毫无意见，那不就没问题了？"
    ...
    ahe "有道理。那...我们回头见？"
    shishou "不想我跟你去？"
    ahe "呃...还是算了吧...我还是不把你卷进我的更多破事比较好..."
    shishou "哦，如果你是这么想的话，阿鹤，你知道吗？"
    ahe "嗯？"
    shishou "和你在逝乐园瞎胡闹其实挺开心的。"
    ahe "啊..."
    shishou "怎么说呢？有种扼住命运的咽喉，趁着天罚降下前肆意施暴的快感。"
    shishou "这何尝不是一场交易呢？你默不作声地利用我，我也一声不吭地利用你。当然最后只有我得偿所愿，彻底地在现实中消失了。"
    shishou "所以作为我占你便宜的补偿，我告诉你一件事。"
    ahe "...我听着呢。"
    shishou "你直到现在为止见到的王霜全都不是真的。真正的她藏在一个更深的地方，连我也从来没有到达过。"
    ...
    stop music fadeout 1.0
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你的头脑正试图厘清眼前无头尸最后那突兀的道别，根本无暇顾及她向前伸出的双手。"
    extend "\n那拼接而成的残缺肢体在接触到你躯干的瞬间爆发出了出人意料的怪力，轻轻一使劲就把你推进了身后门外的无底漆黑中。"
    extend "\n借着她身后银白沙漠里的微光，你看见她楚楚动人的双眼里难以形容的错杂情感——或许有些解脱后的快意，似乎又掺杂了些斩断过去的怅然。"
    extend "\n她的嘴唇微微动了动，你却听不见任何声音。你的嘴也张着，与周身无边的幽暗一同沉寂。"
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "她大概确实是“自由”了，就像她设想的那样。"
    extend "\n因此，这场无止境的下坠大抵就是你们之间最体面的离别？毕竟你曾经也多多少少为她的“自由”摸爬滚打过。"
    extend "\n开心么？"
    extend "\n有更多的问题要问王霜了。"
    extend "\n所以请在这无限的下坠中探明她的下落吧。"
    ## Extended大文本框结束
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "无疑，在这孤独的下坠中，没有人会帮助你穿梭不同世界。"
    ...
    extend "\n没有落脚点，没有抓手，也没有终点。"
    extend "\n当肢体与大脑习惯了长时间且恒定的重力加速度后，你只觉得自己漂着。"
    extend "\n在上不见顶下不见底的世界中央，你一动不动地漂浮着。"
    extend "\n真想做些什么啊。"
    extend "\n无所事事地漂在水面的时候，最想做的事情是什么呢？"
    extend "\n——应该说平时绝不会做这样的事情，因为直视深海的幽暗让你想死。"
    extend "\n当无底无际的黑色幕布在你面前展开时，你总感到不明就里且超越死亡的恐惧。"
    extend "\n然而此刻你只是气定神闲地注视着眼前的无底深渊，心中毫无一丝波澜。"
    extend "\n连你的身体都明白，眼前的黑幕就如寒夜里的窗纱纸般轻薄。"
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "…"
    extend "\n……"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "水底捞月的主要难点不在于这项行为的徒劳本质，而在于其中的视觉刺激所造成的悲剧性幻觉。"
    extend "\n波光粼粼的水面将凄美的月色带到了人们的面前，即使深知真正的明月高挂天顶，人们也总要举杯，假装眼前水中明灭的就是本物。"
    extend "\n纵使是伪物又如何？那真正的月亮还不是置身千里之外，只是一件可望不可即的苍白挂饰而已？倒不如眼前水面这近在咫尺的亮晶晶物件，会随着水面泛起的涟漪而波动，偶尔又在手指动作间阴晴圆缺。"
    extend "\n久而久之天上的清辉全然失却了人们的注视，水面的那轮破镜则长此以往地满足着人们徒劳的亵玩。"
    extend "\n即使从某天起，月亮确实沉入水底，仅需稍稍伸手便能捞起，也无人知晓。"
    extend "\n而这一切全部始于光的折射——幻觉。"
    extend "\n非常简明易懂的原理，但从古至今人们试图水底捞月的徒劳悲剧依旧反复上演。"
    extend "\n你意识到，这徒劳的轮回今天必将在你手上断裂。"
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "…"
    extend "\n……"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你全身上下的感官都在告诉你——撕碎眼前的简明幻象，只需要非常简单的动作。"
    extend "\n究竟是怎样的动作呢...？"
    extend "\n再次睁眼，你的惯用手下意识地向前伸出，手心里满是流水般的黑暗。"
    extend "\n五指并拢，宛如竹篮子打水，夜幕尽数流走。"
    extend "\n那是意料之中的结果，但你愤懑不已，好像只要握得再紧一些，就能牢牢抓住这消逝的夜色。"
    extend "\n窗纱纸般轻薄的夜色，失却了那轮可歌可叹的清辉，却仍然散发出迷人气息。"
    extend "\n因此你必要通过永远的下坠以永远陷落其中，这是无可奈何的事情。既然你被迫沦落到这个境地，而这个“境地”又是如此的令人无法自拔，那又有什么理由逃离？"
    extend "\n使命？"
    extend "\n可使命究竟是水里的那轮明月，还是天上的？"
    extend "\n抑或是水底的？"
    ## Extended大文本框结束
    ...
    extend "\n幻觉。"
    extend "\n只有幻觉..."
    extend "\n只要人们继续单纯伸手而无动于衷，就只能触到眼前触手可及的幻觉，这是亘古不变的恒定事实。"
    extend "\n所以能够探明是非的动作，似乎从始至终就只有一个。"
    extend "\n你把惯用手收回来，然后全身摆出了你上学时熟练掌握的游泳入水动作，双臂向前挺直，浑身略微呈弓形，义无反顾地跃入夜色的海里。"
    ## Extended大文本框结束
    ## 扑通落水声
    ## 居中大字文本框开始 - centered large font textbox
    centered_large_narrator "水面的涟漪终将散去，但水底的月亮终于在无尽的黑暗后在你眼前亮起。"
    ## 居中大字文本框结束
    ## 居中大字文本框开始 - centered large font textbox
    ...
    ahe "这次恐怕没机会了。"
    wangshuang "哦，我以为你排除万难回到这里，是理解一切之后才做出的慎重选择。"
    ahe "应该说是发现自己无法理解一切之后做出的无奈选择。"
    wangshuang "嗯，差不多吧。"
    ...
    wangshuang "当然，因为我的意志占一半权重，所以虽然我的愿望不一定会实现，但违背我愿望的事情绝对不会实现。"
    ...
    wangshuang "而你，我的老朋友，说你是被默许的头号公敌也不为过。你的一举一动都受到密切关注，任何出格行为都会立刻遭到排异反应，所以如果你想要做什么的话——"
    ahe "所以你想要我做什么？"
    wangshuang "我不想要你做什么，你是自由的。"
    ahe "我早就不再纠结那个问题了。反倒是你，一意孤行非要带我回到这里，难道只是想看我受罪？"
    wangshuang "万一真就仅此而已？"
    ahe "要真是那样...哼...哈哈，只能说不意外。但这次你骗不过我。"
    ...
    stop music fadeout 1.0
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "合作宣言正进行到一半，王霜就如轻烟般消散了，仿佛蜂巢不愿她再和你多说哪怕一句话。"
    ...
    extend "\n虽然那东西看似近在眼前，但当你真的伸出手时，才发现你们之间相隔超过一整个银河系的距离。"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "王霜征收了世间全部的自由，再均匀分配给每个人的意识，那么她究竟是解放人类的自由战士，抑或只是一介危权暴君？"
    ...
    extend "\n多么讽刺的里程碑——令无数人趋之若鹜的水底之月，其本质竟是如此不明不白之物。"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "可为什么眼角有些肿胀？盐分和水珠在眼眶周围汇集，但你没有允许它们进一步去完成使命。"
    extend "\n那是不合时宜的。"
    extend "\n虽然没有人在看就是了。"
    extend "\n没有人。"
    extend "\n永远也不会有人看了。"

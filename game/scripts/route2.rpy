...
## 二周目：水底捞月
    ...
    ahe "但你明明是在乎——"
    wangshuang "狗屁。"
    ahe "——所以为什么要说出你绝不会认同的话呢？"
    wangshuang "阿鹤...这里与常识和记忆一点边也搭不上，所以不要再用你‘所熟知’的那套狗屁来烦我。"
    ahe "..."
    ...
    ahe "...很奇怪..."
    wangshuang "这有什么好纠结的，都来这儿了还考究认知？"
    ahe "好吧..."
    ...
    extend "\n入口时的冰凉转瞬即逝，随即传来细微的灼烧感，比辣味更微妙些，像一轮排列整齐的钝铁钉轻轻滚过口腔粘膜。"
    ...
    ahe "阿霜，你听我说——"
    wangshuang "阿鹤！阿鹤你先听我说！你的病没人有治疗经验，所以出院后的康复我们也只能摸着石头过河，现在出了问题我真的...【“伪”字背景闪过】真的非常抱歉！但我肯定会帮你控制住的，我保证！"
    ...
    extend "\n——当然了，有这样的情绪是再正常不过的事情，但问题关键在于我们如何消化这种想法。以后每当你有这种冲动的时候，可以试试先在脑子里排练一阵，搞明白把你厌恶的事物彻底毁掉需要做什么。"
    extend "\n——啊？为什么？"
    extend "\n——嗯，这么想吧，排练的过程本质上是计划，而计划则是往冲动中注入理性，所以你排练出的结论完全不重要，重要的是你完成了排练这件事。"
    extend "\n——可如果排练完了反倒更想做了怎么办？"
    ...
    extend "\n切肤之痛？"
    extend "\n你意识到自己从未试图与水母沟通过。"
    extend "\n无言的水母只能通过肢体语言与你互动，而她此前的一切举动在你未经思考的眼里看来无不是恶毒的进犯。"
    extend "\n可带来疼痛的，就一定是敌人么？"
    extend "\n你究竟在挣扎什么？"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "触手在你体表继续游移，其中一根顺着你的右臂一圈圈缠绕上来，直到尖端刚好落在你手掌附近。"
    ...
    extend "\n想死的冲动愈加强烈，但在这个连死的概念都不存在的世界里，你只能在战栗中咬紧牙关，并继续正视自己。"
    ...
    ahe "当然，我不像你那样聪明而无情...对我来说，送别是有那么一点点动人的...就只有一点点..."
    ahe "你问尤里娅对于我的意义，可你心里一定清楚，我从来都不敢直面事实，毕竟你就是利用了这一点才走到了这里。"
    ahe "确实逃避了很久啊...但我从最开始就明白的...她的本质根本不重要，因为她对我而言从始至终都...只是一块用来逃离日常的跳板。一件工具。"
    ## Extended文本框开始 - accumulating textbox
    ...
    extend "\n银白沙漠的一隅，一扇门突兀地耸立着。"
    extend "\n门前沙地上印着一串脚印，门板半掩。"
    extend "\n你打算尽快穿过那扇门，但随着你越发接近门边，那念头很快便被掩盖了。"
    ...
    ahe "你这...呃...好奇也要分一分场合吧！"
    shishou "毕竟来这儿之前你可是把我大卸八块了那么多次，我姑且算是以眼还眼。"
    ahe "对不起..."
    ...
    shishou "嗯，不用纠结，你就是。"
    ahe "...扎心啊..."
    shishou "可就算是人渣又怎么了？为了愿望而不择手段，概率上来讲必然是最优解。况且你的“受害者”对此毫无意见，那不就没问题了？"
    ahe "你是不是忘了我杀了很多逝乐园私警这件事..."
    shishou "哦...杀人犯的心理咨询，你还是去问王霜比较好。"
    ahe "说起她，你知道她去哪儿了吗？"
    shishou "不知道，我们从来不过问对方的去向。但这道门肯定是留给你的，毕竟我也用不上。"
    ahe "有道理。那...我们回头见？"
    shishou "不想我跟你去？"
    ahe "呃...还是算了吧...我还是不把你再次卷进我的破事比较好..."
    shishou "哦，说起你的破事，阿鹤，你知道吗？"
    ahe "嗯？"
    ...
    stop music fadeout 1.0
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你正试图厘清眼前无头尸最后那突兀的道别，却根本无暇顾及她向前伸出的双手。"
    extend "\n那拼接而成的残缺肢体在抓到你躯干的瞬间爆发出了惊人的怪力，一使劲便把你扔进了她身后门外的无底漆黑中。"
    extend "\n借着她身后银白沙漠里的微光，你看见她楚楚动人的双眼里难以言喻的错杂情感——或许有些解脱后的快意，似乎又掺杂了些斩断过去的怅然。"
    ...
    ## Extended大文本框结束
    ## 居中大字文本框开始 - centered large font textbox
    centered_large_narrator "水面涟漪终将散去，而水底的月亮则在无尽黑暗背面藏身良久后，于你眼前亮起。"
    ## 居中大字文本框结束
    ## 居中大字文本框开始 - centered large font textbox
    ...
    menu:
        ...
        "为什么要“帮”你？":
            ...
            extend "\n如要离开的话，当我什么都没有说过就行，你会重入轮回，长此以往直到时间磨灭。"

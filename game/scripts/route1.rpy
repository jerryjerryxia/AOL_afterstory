...
## 一周目：浮潜
    ...
    extend "\n甜味的颜色？金黄的莓红的草绿的深棕的，味觉的色彩洪流汇入弥漫整个视觉空间的海蓝色波浪中。"
    extend "\n你抬头望向王霜，她也望着你，脸上含蓄地挂了一抹邪魅而欣慰的笑，仿佛望着一个迷路的孩子。她略卷的深绿色长发在空间的蓝色波浪中如死掉的海藻般漂浮。"
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你心中对她海啸般的恶意现在已是荡然无存了——你变得几乎有些喜欢她现在的样子，宛如一个母亲，又像是神明，给视野不断抹上温柔的蓝色。"
    ...
    extend "\n燥热意识模糊，痛苦消减。鼓的声音。恒久的鼓声从背景里逐渐浮现，强烈起来，震耳欲聋，每一击都与心跳同调。在这暧昧混沌里，你感到安逸。"
    extend "\n这样就够了。"
    ## Extended大文本框结束
    ...
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "更多思绪已无意义。"
    extend "\n溶解在蓝色空间中的凉爽糖分让你浑身的燥热与恶意消减了大半，你置身一片透明的海域里，又像是漂浮在空洞的宇宙空间中。"
    extend "\n此刻，你只想在这静谧安详的世界里睡去。"
    ## Extended大文本框结束
    ## 色彩开始还原
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "然而当你行将合眼时，一阵强烈的恶心感自胃里上涌。"
    extend "\n随着一阵剧烈的肠胃痉挛，你“哇”地一声吐了出来。"
    extend "\n和你所熟知的呕吐不同，你吐出的只有色彩。"
    extend "\n呕吐物与面前桌子接触的瞬间，水蓝的桌面恢复了木材的颜色，这令人沮丧的还原随着你吐出更多的色彩而提速，很快覆盖了大半个视野。"
    ...
    extend "\n也许无论如何都必须去向更加遥远的地方。更加遥远，更加遥不可及，更加可望不可即。"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你绝望地想要把头抽出来，但原本稀松的沙地此刻如钢钳一般将你的头死死扼住，沙地之上狂乱挥舞的手臂也不能帮助你分毫。"
    ...
    menu:
        ...
        "我必须知道":
            ...
            wangshuang "意义？意义已经结束了，阿鹤。你所知的一切都已经结束了，这里只有完美的夏日，以及你和我。"
            ahe "你和我的重要性是？"
            ...
            ahe "那就这样吧。"
            ## Extended文本框开始
            "倦意填满了你的全部意识，但你无论如何也无法入睡。在灰白夏日的牢笼中，你与王霜四目相对，连说话的力气也不剩了。眼前的女子既是狱长，又是囚徒， 你们在她一砖一瓦精心搭建的完美监狱中意识清醒地度过无限的时间。"
            ## Extended文本框结束
            ## Extended文本框开始

...
## 一周目：浮潜
    ...
    ahe "可它分明是全天空最暴烈而盛气凌人的东西。"
    wangshuang "那就闭上眼睛，那样你的问题便迎刃而解了。"
    ahe "可我还是我觉得我快要..."
    ...
    ahe "我还要——我还得..."
    wangshuang "我在听。"
    wangshuang "不用紧张，阿鹤，这里是绝对安全的，你可以畅所欲言。"
    ahe "想不起来...什么都想不起来..."
    wangshuang "想想你为什么来到这里，或者想想你用你先前的时间做了什么事，都能帮助你回忆过去。"
    wangshuang "但即使什么也想不起来也不必懊恼，那是必要的过程。"
    ahe "这...这肯定又是你的把戏！"
    wangshuang "总是向外归因可解决不了问题啊，我的朋友。"
    wangshuang "你的病虽然看似已经根治，但以你此刻的身心状态而言，任何时候复发都不意外。"
    wangshuang "但你还是没回答我的问题——时间对现在的你而言，有什么用？"
    ahe "没用...完全没用...都结束了..."
    wangshuang "哦？所以还是想起来了一些。"
    ahe "你...我...我们...毁掉了整个逝乐园。"
    wangshuang "不必谦虚，阿鹤，这件事少了你是绝对不可能成功的。"
    wangshuang "所以我愿意把领衔主演的名头让给你，我可以当制片人。"
    wangshuang "你也不用觉得我抬举你了。过度谦虚只会让人心里生出逃避责任的习惯，是一种需要调整的心态。"
    ahe "我..."
    ...
    ahe "因为它想死。"
    wangshuang "错——太阳自出生的那刻起便像一颗氢弹般自毁，早就动了死的念头，但它还是在天上烧了四十多亿年。"
    ahe "我不明白..."
    ...
    extend "\n而使命则是彻头彻尾、由内而外的——只有在‘使命’松手之后，‘想法’才配拥有一些虚假的自由。"
    ## Extended文本框结束
    ahe "这和我们又有什么关系？"
    ...
    ahe "好吧...如果一切都无需解释，那我就只能在这里和你比干瞪眼了。"
    ...
    wangshuang "——噗噗呃啊——我败了..."
    ahe "自取其辱啊，阿霜。"
    wangshuang "你还有脸得意！能盯着你那张臭脸看还不笑的就只有瞎子和死人了。"
    ...
    ahe "什么都看不到。"
    wangshuang "凑近点啊你，看仔细了！"
    ahe "啊你别拽我！"
    wangshuang "对准了，仔细看好。"
    ahe "呃...嗯？——啊啊啊啊啊啊啊啊啊啊啊！"
    ## 背景开始旋转，白屏逐渐溢满了整个屏幕
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你双眼完成聚焦的一瞬，一阵刺眼的光晕便抹去了视野里的一切，仿佛王霜把天上那轮烈日移植进了你的眼球。"
    extend "\n你拼命合上双眼，整张脸上的肌肉拧成一团，死死挤压你抽搐的眼帘，但为时已晚，那令人绝望的强光已经在你脑海更深处生了根。"
    extend "\n随着炫目的光而来的是蚀骨的火。这由内而外的火顺着你的双眼、你的视神经蔓延开去，后脑勺烧了起来，随后是整个大脑皮层，最终你的全身都在这挥之不去的炫光中熊熊灼烧。"
    ...
    ahe "什么都可以，什么都胜过和你困在这里。"
    wangshuang "啊，已经这么遭人嫌了么..."
    ahe "...多少有点自知之明吧你..."
    wangshuang "彼此彼此，我们都只是遵循着强烈的愿望，尝试了一直以来想要尝试的事情。"
    ahe "但我没有逼着整座城市的人和我一起消失。"
    wangshuang "不，区别在于我做到了，而你没有。"
    ahe "..."
    wangshuang "而你拒绝与我共处一室的真正原因只是嫉妒罢了。"
    ahe "闭嘴吧..."
    wangshuang "我闭嘴又有什么用？难道你那苍白的“理想”就不需要陪葬者了？"
    ...
    wangshuang "所有东西都是饱满到极致的，你懂我意思吗？就不是感官上的饱满，而是存在上的饱满，第四维度上的饱满，就是那种...不论我们怎么干涉都无法改变的状态。"
    wangshuang "然后我就觉得“我操这下不得了了要被外部存在的压强挤碎了快他妈跑”...也不知道是被谁拉住的，是你吗？应该不是，你应该拽不住我。"
    wangshuang "总之要不是后来配了眼镜，不然我是绝对不敢再磕KAS的，第一次是真的差点死了..."
    ahe "哦，原来你那“磕完药差点死掉的小故事合集”还在更新。"
    wangshuang "那可是正儿八经的人命啊喂！"
    wangshuang "不过毕竟我本来就有点毛病，一般人体验不会那么夸张。你会喜欢的，我觉得。"
    ahe "那我拭目以待——所以我们要在这里待到什么时候？"
    ...
    ## 色彩开始还原
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "然而当你行将合眼时，一阵强烈的恶心自胃里上涌，就像有人抓住你的肠胃，自下而上地用力挤压着。"
    extend "\n警告：过热。过热。"
    extend "\n钟表嘀嗒作响。"
    ...
    extend "\n保持呼吸。"
    extend "\n空气中充斥着一股微妙的甜腻味道。"
    extend "\n在童年故乡的某个傍晚，太阳将要落山，你踌躇满志地幻想你的未来的时候，也闻到过这样的味道。"
    extend "\n它让你想起一些美好但没有意义的事情。"
    extend "\n无论如何也找不到，但要保持呼吸。"
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    ...
    ahe "那你为什么要做这个梦？"
    wangshuang "嗯...当然是是因为后悔，否则人是不可能来到这里的。"
    ahe "还有能让你后悔的事？"
    ...
    wangshuang "所谓‘全知全能’，虽然听着像是神话中造物主才被允许拥有的伟力，但事实上以今天的技术，想要在有限时空里模拟这一状态根本不难。"
    wangshuang "试想，假若在我们与杰罗瓦的最后一战里，你在见到他放出的尤里娅们就立刻放弃了抵抗，会怎么样？一切就结束了对吧？那你再想，如果我能把这段不存在的“记忆”模拟出来，数据化掉，然后灌回你脑子里，那是不是就实现了“认知草拟”？"
    wangshuang "而一旦单线程草拟跑通了，双线程自然也就不是问题。"
    wangshuang "那双线程跑起来，让被试同时体验选择支两边发生的事，草拟完成后被试就已经‘全知全能’了，不是么？"
    ahe "可这人在现实中并不是这样的啊。"
    ...
    ahe "他们在自行草拟？"
    wangshuang "没错。人工植入的认知流并没有在结尾处安排收束性事件，而在我们灌进去的认知与现实发生冲突后，被试们全部选择了无视现实，并开始自行草拟选择支两边的后续内容。"
    ...
    wangshuang "一个人双线程草拟时需要的算力...这么说吧，会在草拟开始后的短时间内爆炸，而最初的草拟全是在被试脑内执行的...。"
    ahe "..."
    wangshuang "嗯，第一批的脑子全烧了，物理意义上的。后来第二批还动用了医院的计算机，效果也没好多少就是..."
    ...
    wangshuang "你觉得呢？"
    ahe "我怎么知道..."
    wangshuang "嗯，无知是福啊，阿鹤。"
    ahe "行吧，只要你心安理得就行。"
    wangshuang "..."
    ahe "所以这梦也是你那朴素过程的一部分？"
    wangshuang "那不一样，能够来到这里的都是游离于朴素过程之外的异客，而当他们离开这里时，我希望他们至少能明白自己为什么必须要这样游离。"
    ahe "唔，所以这也是你的实验的一部分，带课题的。"
    wangshuang "不不不，这里可是治疗场所。我不会控制任何变量，而你永远是自由的。换言之，课题得你自己定。"
    ...
    ahe "可很难不在意啊。如果快乐如此简明，那我之前做的一切又是为了什么..."
    ...
    menu:
        ...
        "我必须知道":
            ...
            extend "\n那精致而脆弱的空虚，只能在这绝对无尘的美好光景中存在，连一丝空气的振动都会令其支离破碎。"
            extend "\n你决定保持沉默。"
            extend "\n她并不是囚徒。"
            extend "\n这里的囚徒只有你一人。"
            extend "\n你只能继续等待下去。"

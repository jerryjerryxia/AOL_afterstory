...
## 一周目：浮潜
    ...
    wangshuang "嗯，从之前的病史来看，你总是在这两个状态之间来回反复，但具体是什么感觉？说来听听。"
    ahe "..."
    wangshuang "连这也说不出来？"
    wangshuang "说不出来的话，聊聊你看到的，或者听到的，都是可以的，我在听。"
    ...
    wangshuang "这是你的心理咨询，你是来访者，而我是咨询师，这样想必就足够说明问题了。"
    ahe "所以...我该怎样才能好起来？"
    ...
    ahe "我还要——我还得..."
    wangshuang "我在听。"
    wangshuang "不用紧张，这个地方是绝对安全的，你可以畅所欲言。"
    ahe "想不起来...什么都想不起来..."
    wangshuang "想想你为什么来到这里，或者想想你用你先前的时间做了什么样的事情，都能帮助你回忆过去。"
    wangshuang "但即使什么也想不起来也不必懊恼，那是意料之中的必要过程。"
    ahe "这...这肯定又是你的把戏！"
    wangshuang "总是向外归因可解决不了问题啊，我的朋友。"
    wangshuang "你的病虽然此前已经看似根治，但以你的身心状态而言，任何时候复发我都不意外。"
    wangshuang "但你还是没回答我的问题——时间对现在的你而言，有什么用？"
    ahe "没用...完全没用...一切都结束了..."
    wangshuang "哦？所以还是想起来了一些。"
    ahe "我...我们...毁掉了整个逝乐园。"
    wangshuang "不必谦虚，阿鹤，这件事没了你是绝对不可能成功的。"
    wangshuang "所以我愿意把领衔主演的名头让给你，我当制片人就行了。"
    wangshuang "你也不用觉得我抬举你，过度谦虚会让人更倾向于逃避责任，是一种需要调整的心态。"
    ahe "我..."
    wangshuang "嗯，我懂的，在完成一件惊人的壮举后，出现冒充者综合征是非常常见的事情。"
    wangshuang "但不论你是怎么想的，事已至此，放平心态才是至关重要的事情。"
    ahe "...随便了..."
    ...
    ahe "因为它想死？"
    wangshuang "错——太阳自出生的那一刻起便如氢弹般持续自毁，早就动了死的念头，但它还是在天上烧了四十多亿年。"
    ahe "我不明白..."
    ...
    ## Extended文本框结束
    ## Extended文本框开始 - accumulating textbox
    wangshuang "想法是轻薄的、由外界塑造的，一坨烂泥一样谁都可以捏一把，但同时也是最无足轻重的。"
    ...
    ahe "...？"
    wangshuang "嗯，就是那样，过多的言语会污染概念。你现在还是不要再探究了为好。"
    ahe "哦...对对对...懂了..."
    ...
    wangshuang "你能活到今天确实让我非常惊讶的说。"
    ahe "还不是拜你所赐..."
    wangshuang "不用谢不用谢。那你过来吧，拿走你的战利品。"
    ahe "哈？"
    ...
    large_narrator "自你双眼完成聚焦的一刹那，一阵刺眼的光晕便抹去了视野中的一切，仿佛王霜把天上那轮烈日移植进了你的眼球。"
    extend "\n你死死地挤压着眼帘，但那令人绝望的强光已经在你脑海的更深层生了根。"
    extend "\n随着炫目的光而来的是蚀骨的火，这由内而外的火顺着你的双眼、你的视神经蔓延到大脑皮层，最终你的全身都在这挥之不去的炫光中熊熊灼烧。"
    extend "\n你将身子团成球状、死死绷住全身肌肉以抵御这钻心之痛，但在光与火的海啸面前也只是杯水车薪。"
    extend "\n就像太阳一般稳定..."
    ...
    wangshuang "所以你准备换个地方无所事事。"
    ahe "再无所事事都胜过和你困在这里。"
    wangshuang "啊，已经这么遭人嫌了么。"
    ahe "...多少有点自知之明吧你..."
    wangshuang "彼此彼此了，你我做的事本质上并无差别，只是遵循着强烈的愿望，尝试了一直以来想要做的事情。"
    ahe "区别在于我不需要陪葬者。"
    ...
    wangshuang "你为了尤里娅那小姑娘折断了多少人的骨头？阿鹤，继续挣扎是没有意义的，因为无论如何我们都是逝乐园覆灭的凶手与共犯。你是无处可逃的。"
    ahe "..."
    ...
    ahe "你自己不也在做同样的事情。"
    wangshuang "我是我你是你。而且我只是不想看着我欣赏的人和我坠入同样的深渊嘛。"
    ahe "别恶心我了，求你了。"
    wangshuang "你这人，连真心话都不让人说，未免有些无情了呢，阿鹤。"
    ahe "你？真心话？这笑话可以再冷点么。"
    wangshuang "随你怎么说吧。"
    ## 把玩无色透明多面体差分3
    wangshuang "哦，对，团子有得是，千万别客气，请吧——"
    ahe "明明刚说完不想我染上KAS。"
    wangshuang "生理上确实不怎么成瘾，这个东西。"
    wangshuang "但太多人沉溺于它能让人看到的那些东西，最后心里离不开了，所以你才见到那么多嗑KAS的人。"
    wangshuang "那么你会怎样呢，阿鹤？我很期待。"
    ahe "只致幻的话岂不是很无聊，尤其对你来讲。"
    wangshuang "无聊？KAS可别太刺激了！你知道十二小时起步的感官过载是什么感觉吗？"
    wangshuang "五感敏感度全部推到极致，尤其是视觉，所有东西的颜色都比平时看到的要鲜艳无数倍，而且全都彼此交融，到最后视野里就是五彩斑斓的白。"
    ...
    wangshuang "总之要不是后来配了眼镜，不然我是绝对不敢乱用KAS的，第一次是真的差点死了，呼！"
    ahe "你磕完药差点死掉的故事...反正我是见怪不怪了..."
    wangshuang "那可是正儿八经的人命啊喂！"
    wangshuang "我倒也算是特例了，毕竟本来就有点毛病。你会喜欢的，我觉得。"
    ...
    ahe "你看，你自己都自首了。还不逮捕你自己。"
    wangshuang "那我还得兼任检察官辩护律师和法官，太麻烦了。"
    ahe "在这种时间失去意义的世界里用来消磨时间，不正合适？"
    wangshuang "不不不那就不对了，如果你还想“消磨时间”，那就说明你修为尚浅，没搞明白。"
    ahe "...好的，师傅。"
    ahe "话说你手里拿的是什么？"
    ## 递过无色透明多面体
    ...
    ## 色彩开始还原
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "然而当你行将合眼时，一阵强烈的恶心自胃里上涌，就像有人抓着你的肠胃，自下而上地用力挤压着。"
    ...
    extend "\n眼前桌子的存在与本质看起来产生了某种根本性的分离，但你已经没有心力去捕捉这种高深的细节了。"
    ...
    menu:
        ...
        "放弃。":
            ...
            "女人的声音，那嗓音神秘而熟悉 - 你的病终于也和我一样了，我羸弱的爱人。"
            "你听见那声音，就像听见了复活的钟声，虽振聋发聩，却让你义无反顾地站了起来。"
            "要去哪儿呢？"
            "总是要去些地方。即使不呼吸也罢。"
            "治病也罢，杀人也罢。"
            "总之要去些地方。"
            "在无际的灰幕中，你把灰色踩在脚下，开始仔细思考接下来要去的地方。"
            ## 黑屏
    ...
    ahe "我不理解..."
    wangshuang "当然。人无法理解的事情可太多了，阿鹤，需要理解的东西也没那么多。"
    ahe "这也是一种较为朴素的过程？"
    wangshuang "这不一样。这仅针对于你。"
    ahe "所以你和我是不一样的。"
    wangshuang "倒也不能这么说。我们都是难以言喻的废物，只是你不承认罢了。"
    ahe "我早就承认了...你究竟还想从我这里索取什么！"
    wangshuang "你只需要告诉我，为什么还要搭这无谓的尸首？"
    ahe "..."
    wangshuang "阿鹤？"
    ahe "..."
    wangshuang "阿鹤？"
    ...
    wangshuang "因为我看不见。"
    ahe "那我们就在这里一直待下去也无妨。"
    wangshuang "哎，如果你觉得那是对我的某种威胁的话，你还是省省吧。你看，从各种意义上来讲，你的作品已经完成了。"
    ahe "什——"
    ## 炸裂jump scare音效

...
## 一周目：浮潜
    ...
    large_narrator "你反倒比先前要更加冷静，又低头吃了几口团子。甜腻腻的滋味在口腔中涟漪般散开，每颗味觉细胞都在欣喜若狂地发送着饱足的信号。"
    large_narrator "甜味的颜色？金黄的莓红的草绿的深棕的，味觉的色彩洪流汇入弥漫整个视觉空间的海蓝色波浪中。"
    large_narrator "你抬头望向王霜，她也望着你，脸上含蓄地挂了一抹邪魅而欣慰的笑，仿佛望着一个迷路的孩子。她略卷的深绿色长发在空间的蓝色波浪中如死掉的海藻般漂浮。"
    ## 大文本框结束
    ## 大文本框开始
    large_narrator "你心中对她海啸般的恶意现在已是荡然无存了——你变得几乎有些喜欢她现在的样子，宛如一个母亲，又像是神明，给视野不断抹上温柔的蓝色。"
    large_narrator "每一缕神经都在扩张。启示性的景象。时间和空间波浪。无孔不入的色彩和甜味。蓝色的。交响。"
    ...
    large_narrator "成瘾。糖分子使你逐渐成瘾。"
    large_narrator "渴望的源头冲动的源头想往的源头发现了。"
    large_narrator "浪潮般的甜味反复沁进意识。她开始微笑。她停止微笑。目光所及之处就能看见她的微笑。"
    large_narrator "燥热意识模糊，痛苦消减。鼓的声音。恒久的鼓声从背景里逐渐浮现，强烈起来，震耳欲聋，每一击都与心跳同调。在这暧昧混沌里，你感到安逸。"

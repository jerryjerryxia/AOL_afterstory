...
## 一周目：浮潜
    ...
    wangshuang "而当我们不得不把那些千疮百孔的认知数据物归原主时，后面的事情你应该也能猜到了。"
    ahe "所以最后全死了么..."
    wangshuang "嗯，脑子全烧了，物理意义上的。而这，就是凡人追求全知全能的代价——哪怕在单个选择事件这样的微小的范围内，也没人或任何现代计算机能够承受得住这它的算力需求。"
    ...
    ahe "所以为什么没有让其他被试进来..."
    wangshuang "哦...哈哈...这个嘛，毕竟当时搭得比较匆忙，这个梦境第一版的认知收束处理速度不仅只能单线程，还非常慢，所以救不了太多人...哈哈..."
    ahe "..."
    wangshuang "..."
    ahe "这也是你追悔莫及的一部分？"
    wangshuang "不是。"
    ...
    wangshuang "因为我看不见。"
    ahe "那我就在这里一直待下去也无妨。"
    wangshuang "哎，我也没说缺了头骨就不行啊。你看，你“作品”从各种意义上已经完成了。"
    ahe "什——"
    ## 炸裂jump scare音效
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你绝望地想要把头抽出来，但原本稀松的沙地此刻如钢钳一般将你的头死死扼住，沙地上狂乱挥舞的手臂也无法帮助你分毫。"
    ...
    menu:
        ...
        "我必须知道":
            ...
            wangshuang "没了。"
            ahe "这...难道就是试图同理的代价？"
            wangshuang "嗯...如果一定要说的话，这甚至不能称之为代价，因为你只看到了世界的一角。没有退路只是绝望的开端而已。"
            ahe "但你想要离开这里其实易如反掌吧？"
            ...
            ahe "那就这样吧。"
            "倦意填满了你的全部意识，但你无论如何也无法入睡。"
            "在灰白夏日的牢笼中，你与王霜四目相对，连说话的力气也不剩了。"
            "眼前的女子既是狱长，又是囚徒，你们在她一砖一瓦精心搭建的完美监狱中意识清醒地度过无限的时间。"
            "并不是一场对杀或审问，只是沉默的两人在完整的世界里等待崩溃的发生，仅此而已。"
            "仅此而已。"
            "数千或数万次潮起潮落后，你终于下定决心问王霜太阳是否会在某个时刻落下或爆炸，但还未张嘴就打消了这个念头。"
            "你看见她心满意足地望着眼前一成不变的光景，双眼里只留下了某种接近于疯狂的极乐。"
            "万物皆落入她深邃的眼底，在光信号到电信号的转码过程中被碾得粉碎，逐渐成为更加无意义的存在。"
            "你也不例外，任其将你纳入她视野的巨大黑洞中，成为幅员辽阔的空虚的一角。"

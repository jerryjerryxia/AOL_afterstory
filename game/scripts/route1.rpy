...
## 一周目：浮潜
    ...
    wangshuang "嗯，从之前的病史来看，你总在这两个状态之间来回反复，但现在具体是什么感觉呢？我想听听。"
    ahe "..."
    wangshuang "连这也说不出来么？"
    wangshuang "难说的话，或许聊聊你看到的，或者听到的，都是可以的，我在听。"
    ...
    wangshuang "那也是无可厚非的事情。                                       <---- 对抗"
    ahe "那怎么可能是——                                                <---- 对抗"
    wangshuang "当然就是这样的，阿鹤。                                       <---- 对抗"
    wangshuang "这是你的心理咨询，你是来访者，而我是咨询师。   <---- 对抗"
    ahe "所以...我该怎样才能好起来？                              <---- 对抗"
    wangshuang "修补本就完整的东西，那自然是做不到的。             <---- 对抗"
    ahe "..."
    wangshuang "你不同意。"
    ahe "...你...求求你不要再浪费我的时间了..."
    ...
    ahe "...？"
    wangshuang "嗯，就是那样，过多的言语会污染概念。你现在还是不要再多探究了为好。"
    ahe "哦...对对对...懂了..."
    ...
    wangshuang "——噗噗呃啊——我败了..."
    ahe "自取其辱啊，阿霜。"
    wangshuang "你还有脸得意！能盯着你那张臭脸看还不笑的就只有死人了。"
    ...
    ahe "...多少有点自知之明吧你..."
    wangshuang "彼此彼此吧，我们都只是遵循着强烈的愿望，尝试了一直以来想要尝试的事情。"
    ahe "区别在于我不需要陪葬者。"
    ...
    ahe "你自己不也在做同样的事情。"
    wangshuang "只是不想看着我欣赏的人和我坠入同样的深渊嘛。"
    ahe "别恶心我了，求你了。"
    ...
    ahe "明明刚说完不想我染上。"
    wangshuang "生理上确实不怎么成瘾，这东西。"
    wangshuang "但太多人沉溺于它能让人看到的那些东西，最后心里离不开了，所以你才能在安息地见到那么多活死人。"
    wangshuang "那么你会怎样呢，阿鹤？我很期待。"
    ...
    wangshuang "然后我就觉得“我操这下不得了了要被外部存在的压强挤碎了快他妈跑”，然后据说是就开始往窗户外面跳...也不知道是被谁拉住的，是你吗？应该不是，你应该拽不住我。"
    wangshuang "总之要不是后来配了眼镜，不然我是绝对不敢乱用KAS的，第一次是真的差点死了..."
    ahe "哦原来你那“磕完药差点死掉的小故事”还在更新啊。"
    wangshuang "那可是正儿八经的人命啊喂！"
    wangshuang "不过我倒也算是特例了，毕竟本来就有点毛病，一般人不会那么夸张。你会喜欢的，我觉得。"
    ahe "那我就拭目以待了。所以我们要在这里待到什么时候？"
    wangshuang "等时机到了，自然就能离开。"
    ahe "这也是一种较为朴素的过程？"
    wangshuang "哦？如此简明且精确的定义，谁教你的？"
    ahe "一个傻逼。"
    wangshuang "好刻薄！"
    ahe "经历过我们之间发生的事情后，只被骂傻逼已经很友好了。"
    wangshuang "所以确实没法放过我了吗？"
    ahe "你还需要人放过？"
    wangshuang "当然，我又不是没有罪恶感的人。"
    ahe "存疑。"
    wangshuang "哎阿鹤，虽然有些事情我确实做得...不太好...从世俗意义上来说，但也没必要这样从根本上质疑我演戏的质量嘛。"
    ahe "你看，你都自首了。还不逮捕你自己。"
    wangshuang "那我还得兼任检察官辩护律师和法官，太麻烦了。"
    ahe "在这种时间失去意义的世界里用来消磨时间，不正合适？"
    ...
    ## 色彩开始还原
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "然而当你行将合眼时，一阵强烈的恶心自胃里上涌，就像有人抓着你的肠胃，自下而上地持续用力挤压。"
    ...
    extend "\n眼前桌子的存在与本质看起来产生了某种根本性的分离，但你已经没有心力去捕捉这种高深莫测的细节。"
    ...
    "原来如此，原来如此。"
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "但呕吐不一样，呕吐是严肃创作的一种。"
    extend "\n只是根据当前病症来看，呕吐的危险性比腹泻更为严重。"
    extend "\n而脱水是两者的共性之一。"
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "24小时核磁共振？小意思！除非阿鹤的骨头是铁做的。"
    ...
    ahe "啊...！"
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "横膈膜早就停止了工作，而当你意识到自己无法呼吸时，一切已经晚了。"
    extend "\n一切？！"
    extend "\n又是他妈的一切！"
    ...
    menu:
        ...
        "保持呼吸。":
            ...
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "仍要坚持？那就继续坚持吧。"
            extend "\n灰幕的蔓延永无止境，一如疼痛的叠加永无止境。"
            extend "\n更多的毒液渗入血管，血液在沸腾，内脏在沸腾血液的浇灌下燃烧，但你只能看见你执意选择的灰。"
    ...
    ahe "那你为什么要做这个梦？"
    wangshuang "嗯...追悔莫及，无动于衷，否则人是不可能来到这里的。"
    ahe "还有能让你后悔的事？"
    wangshuang "当然。任何选择的另一头，都是满满的机会成本烧出来的灰啊。"
    ahe "可如果你已经变成神了——"
    wangshuang "你才变成神了！"
    ahe "好吧..."
    wangshuang "不管多么成功地执行了计划，总会有疏漏，这是无法避免的，自然也就总会有后悔的空间。"
    wangshuang "你也别觉得后悔是什么见不得人的事情。应该说，完全无法后悔的认知架构才真的要命，我之前做过这方面的研究。"
    ahe "什么研究？"
    wangshuang "‘全知全能的代价’。"
    ahe "这一点都不相关吧！"
    wangshuang "别急，听我讲完你就懂了。"
    wangshuang "所谓‘全知全能’，虽然听起来是神话中的造物主才被允许拥有的能力，但事实上以今天的技术，想要在有限的时空里模拟这一状态并不难。"
    wangshuang "试想，假若在我们与杰罗瓦的最后一战里，你在见到他放出的尤里娅后就立刻放弃了抵抗，会怎么样？"
    ahe "...我们就不会在这里了。"
    wangshuang "当然，想必后面还会发生更多惨绝人寰的暴行——但你选择了抵抗，而拜你所赐，我们此刻站在这里。"
    wangshuang "至此，以你见到尤里娅那一刻作为事件节点，再根据你在这个节点的决定，将后续的事件定义为不同选项各自延伸出的选择支——这是一个“选择”事件的底层架构。"
    wangshuang "而每条选择支中的具体内容则可以通过观测现实，或用我的心理视像算法V27.3.9来预测得出。"
    wangshuang "内容明确后，用Succumus精确复现其完整的感官体验，而复现后的感官数据则最终被灌输到被试的认知矩阵中去。"
    wangshuang "这整套流程我称之为“认知草拟”。"
    wangshuang "一旦能够完成单线程的认知草拟，双线程自然也就不是问题。自此，只需要从一个事件节点开始，让被试同时体验选择支两边的事件内容，草拟完成后的被试就拥有了简明的‘全知全能’。"
    ahe "但这人在现实中并不能同时实现选择支的两侧。"
    wangshuang "当然不能，这所谓的‘全知全能’在外人看来只是痴人说梦般的幻觉，但试想——假若选择支两边的记忆，从肢体感官到事件次序，无不张弛有度地印在你脑海里，那对于一个不了解认知草拟的被试来说，该如何戳穿自己‘全知全能’的假象？"
    ahe "必须要外人点破才行。"
    wangshuang "对，但不全对。即使有外人指出矛盾，又有多少人愿意彻底摒弃自己的“切身体验”，转而允许他人的只言片语来定夺自己的认知？"
    ahe "..."
    wangshuang "事实也是如此。在草拟完成的三天内，所有的被试都明确拒绝了外界暗示，以不容置疑的姿态维持着选择支两边的草拟。"
    ahe "他们在自行草拟？"
    wangshuang "没错。人工植入的认知流并没有在结尾处安排收束性事件。我们最初的预测是当其中一条选择支的后续事件与现实严重不符时，它便会自行收束并让被试回到现实，但结果则完全出乎我们的意料——在人工植入的认知与现实发生冲突后，被试们全部选择了摒弃现实，并开始自行草拟选择支两边的后续内容。"
    wangshuang "更有意思的是，所有被试的中脑皮质边缘通路在自行草拟的过程中都处于持续高度激活的状态，跟多巴胺用不完似的。"
    wangshuang "就仿佛这虚假的全知全能让他们——"
    ahe "成瘾了。"
    wangshuang "Bingo！我们用非自然生成的认知数据让人染上了成瘾性的精神分裂，而这——"
    ahe "就是全知全能的代价？"
    wangshuang "哼，别兴奋过头了，阿鹤。"
    wangshuang "当一个人同时观测选择支两边时，其中必然会出现自相矛盾的“事实”。虽然对于沉溺其中的被试而言这种矛盾主观上无可厚非，但用于维持草拟的计算机必须通过海量的额外计算来调和这些错误。"
    wangshuang "最初的草拟是全部在被试自身脑内执行的，计算量需求的突然暴增无疑会带来一些...问题。"
    wangshuang "随着最初那批被试中的一些人因为认知过载发生脑死亡后，我们把草拟外置到了医院的计算机集群上，但还是不够。"
    wangshuang "我们误算了一点——在算力需求爆炸一次后平稳了很长一段时间，但后来发现这一需求随时间呈现出了多重逻辑斯蒂增长，医院的集群也没能扛过第二次需求爆炸..."
    wangshuang "而那些千疮百孔的认知数据，不管是物归原主还是删除...后面的事情你应该也大致能猜到了。"
    ahe "所以最后全死了么..."
    wangshuang "嗯，回归组的脑子全烧了，物理意义上的，而删除组的则永远失去了这段记忆，但对全知全能成瘾留下的身体记忆已经抹不掉了，所以最后也大多成了废人。而这，就是凡人追求全知全能的代价——哪怕在单个选择事件这样的微小的范围内，也没人或任何现代计算机能够承受得住这它的算力需求。"
    wangshuang "所以说能后悔是好事啊，能用如此无可厚非的情感来替代脑细胞被烧干，是好买卖。"
    ahe "那这个梦..."
    wangshuang "嗯，是我给自己搭的，用来强制认知收束的疗养院。后来发现效果不错，自然也就向一些VIP们开放咯。"
    ahe "你自己也参与了？"
    wangshuang "当然，我是第一批被试哦。就是我的脑子不太一样，成瘾这个问题在我这不存在，可以随时自行结束草拟，所以可以在当被试的同时一边跟进实验。"
    ahe "所以为什么没有让其他被试进来..."
    wangshuang "哦...哈哈...这个嘛，毕竟当时搭得比较匆忙，这个梦境第一版的认知收束任务只能单线程地跑，慢的不行的同时还会很吃资源，所以救不了太多人...哈哈..."
    ahe "..."
    wangshuang "..."
    ahe "这也是你追悔莫及的一部分？"
    wangshuang "不是。"
    ...
    wangshuang "..."
    ahe "所以这也是一种较为朴素的过程？"
    wangshuang "那不一样，能够来到这里的都是游离于朴素过程之外的异客，而当他们离开时，我期望他们至少能明白为什么自己必须要这样游离。"
    ahe "唔，所以也是你的实验的一部分，带课题的。"
    wangshuang "不不不，这里可是治疗场所。我不会控制任何变量，而你当然永远是自由的。换言之，课题得你自己定。"
    ...
    ## Extended大文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "你绝望地想要把头抽出来，但原本稀松的沙地此刻如钢钳一般将你的头死死扼住，沙地表面狂乱挥舞的手臂也无法帮助你分毫。"
    ...
    extend "\n你极力控制呕吐欲，但那念头很快就被另一种思绪所覆盖了。"
    ## Extended大文本框结束
    ## 居中大字文本框开始 - centered large font textbox
    centered_large_narrator "你想死。"
    ## 居中大字文本框结束
    ## Extended大文本框开始 - accumulating large textbox
    large_narrator "尸体气味的烈度达到了顶峰。"
    extend "\n你早就清楚那气味的来源，只是还在试图移开目光。"
    extend "\n然而逃避与走投无路总是形影相随。"
    extend "\n当一个人制造了过多的尸体，其也会提早步入其造物的行列。"
    extend "\n与命运或报应无关，因为那是唯一的解决方案。"
    extend "\n你想死。"
    extend "\n你拼尽全力扼住自己的脖颈；你听见脑血管的轰鸣；视野四周开始坍缩，无际的黑暗；你马上就要成功了。"
    extend "\n地心引力渐强，你的身躯逐渐被沙砾吞没。人为的窒息终于在血污将你口鼻覆盖之前降临。"
    ...
    wangshuang "无非是一事无成者在自欺欺人罢了。"
    ahe "阿霜，我觉得你有时候太武断了。"
    wangshuang "而你，阿鹤，总是太寡断。"
    ahe "那我现在就给你表演我武断的一面——显得寡断是因为我绝对不想在一颗错误的树上吊死。"
    wangshuang "很好，但在一棵绝对错误的树上吊死让我抵达了这里。"
    ...
    menu:
        ...
        "我必须知道":
            ...
            ## 居中文本框结束
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "远处沙滩椅上的眼睛并不是你的眼睛。它维持着距离，幽幽地观望着你的一举一动。"
            extend "\n你与事物的隔阂一如既往地高耸。你迫切想要融入灰，但这愿望越是强烈，你就越感到身处深灰色的海底，周身却干燥无比。"
            extend "\n窒息。因为这一切都与你无关。"
            ## Extended大文本框结束
            ahe "我想回去了。"
            ...
            wangshuang "没了。"
            ahe "这...难道就是试图同理的代价？"
            wangshuang "嗯...如果一定要说的话，这连代价也称不上，因为你只看到了其中的一角。没有退路只是开端。"
            ahe "但你想要离开这里其实易如反掌吧？"
            ...
            ## Extended大文本框结束
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "并不是一场对杀或审问，只是沉默的两人在完整的世界里等待崩溃的发生，仅此而已。"
            extend "\n仅此而已。"
            ...
            ## Extended大文本框结束
            ## Extended大文本框开始 - accumulating large textbox
            large_narrator "你也不例外，任其将你纳入她视野的巨大黑洞中，成为幅员辽阔的空虚的一角。"
            extend "\n那精致而脆弱的空虚，只能在这绝对无尘的美好光景中存在，任何一丝空气的振动都会令其支离破碎。"
            extend "\n你决定保持沉默。"
            extend "\n她并不是囚徒。"
            extend "\n此处的囚徒只有你一人。"
            extend "\n你只能继续等待下去。"
